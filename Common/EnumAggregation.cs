...
namespace Common
{
    ...
    {
        NONE,
        HandEyeCali = 0,  // 标定相机与机械坐标系的关系0
        CaliCaliBoard,
        Cali9PtCali,
        UpDnCamCalibWcs, // 标定上下相机的位置关系  ， 这个弃用
        UpDnCamCalibPix,
        NPointCali, // N点标定
        CamParamPose, // 用于3D场景的校准
        HomMat2D, // 用于2D场景的校准
        FaceCalib,
        CaliBoardMap, // 用于在标定板上相机间映射
        RefPose,
        NPointAndMapCalib,
        手眼标定,
        标定板标定,
