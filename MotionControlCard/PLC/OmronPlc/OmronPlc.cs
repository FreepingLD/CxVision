                    ...
                    case enUserConnectType.TcpIp:
                        ...
                        switch (param.DeviceModel)
                        {
                            case enDeviceModel.OmronFinsTcpNet:
                                this._CipTcpNet?.ConnectClose();
                                this._CipTcpNet = new OmronCipNet(param.IpAdress, param.Port);
                                connect = this._CipTcpNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._CipTcpNet;
                                ...
                                break;
                            case enDeviceModel.OmronCipTcpNet:
