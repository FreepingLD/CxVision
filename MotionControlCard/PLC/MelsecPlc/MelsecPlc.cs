...
namespace MotionControlCard
{
    public class MelsecPlc : MotionBase
    {
        ...
        private MelsecA1EAsciiNet _MelsecA1EAsciiNet;
        private MelsecA1ENet _MelsecA1ENet;
        private MelsecA3CNet _MelsecA3CNet;
        private MelsecA3CNetOverTcp _MelsecA3CNetOverTcp;
        private MelsecCipNet _MelsecCipNet;
        private MelsecFxLinks _MelsecFxLinks;
        private MelsecFxLinksOverTcp _MelsecFxLinksOverTcp;
        private MelsecFxSerial _MelsecFxSerial;
        private MelsecFxSerialOverTcp _MelsecFxSerialOverTcp;
        private MelsecMcAsciiNet _MelsecMcAsciiNet;
        private MelsecMcAsciiUdp _MelsecMcAsciiUdp;
        private MelsecMcRNet _MelsecMcRNet;
        private MelsecMcUdp _MelsecMcUdp;
                ...
                switch (param.ConnectType)
                {
                    case enUserConnectType.TcpIp:
                        ...
                        switch (param.DeviceModel)
                        {
                            ...
                            case enDeviceModel.MelsecMcNet:
                            ...
                            case enDeviceModel.MelsecA1EAsciiNet:
                                this._MelsecA1EAsciiNet?.ConnectClose();
                                this._MelsecA1EAsciiNet = new MelsecA1EAsciiNet(param.IpAdress, param.Port);
                                connect = this._MelsecA1EAsciiNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecA1EAsciiNet;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecA1ENet:
                                this._MelsecA1ENet?.ConnectClose();
                                this._MelsecA1ENet = new MelsecA1ENet(param.IpAdress, param.Port);
                                connect = this._TcpNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecA1ENet;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                            ...
                            case enDeviceModel.MelsecA3CNetOverTcp:
                                this._MelsecA3CNetOverTcp?.ConnectClose();
                                this._MelsecA3CNetOverTcp = new MelsecA3CNetOverTcp(param.IpAdress, param.Port);
                                connect = this._MelsecA3CNetOverTcp.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecA3CNetOverTcp;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecCipNet:
                                this._MelsecCipNet?.ConnectClose();
                                this._MelsecCipNet = new MelsecCipNet(param.IpAdress, param.Port);
                                connect = this._TcpNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecCipNet;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                            ...
                            case enDeviceModel.MelsecFxLinksOverTcp:
                                this._MelsecFxLinksOverTcp?.ConnectClose();
                                this._MelsecFxLinksOverTcp = new MelsecFxLinksOverTcp(param.IpAdress, param.Port);
                                connect = this._MelsecFxLinksOverTcp.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecFxLinksOverTcp;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecFxSerialOverTcp:
                                this._MelsecFxSerialOverTcp?.ConnectClose();
                                this._MelsecFxSerialOverTcp = new MelsecFxSerialOverTcp(param.IpAdress, param.Port);
                                connect = this._MelsecFxSerialOverTcp.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecFxSerialOverTcp;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecMcAsciiNet:
                                this._MelsecMcAsciiNet?.ConnectClose();
                                this._MelsecMcAsciiNet = new MelsecMcAsciiNet(param.IpAdress, param.Port);
                                connect = this._TcpNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecMcAsciiNet;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecMcAsciiUdp:
                                this._MelsecMcAsciiUdp?.RemoteReset();
                                this._MelsecMcAsciiUdp = new MelsecMcAsciiUdp(param.IpAdress, param.Port);
                                connect = this._MelsecMcAsciiUdp.RemoteRun();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecMcAsciiUdp;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecMcRNet:
                                this._MelsecMcRNet?.ConnectClose();
                                this._MelsecMcRNet = new MelsecMcRNet(param.IpAdress, param.Port);
                                connect = this._TcpNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecMcRNet;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecMcUdp:
                                this._MelsecMcUdp?.RemoteReset();
                                this._MelsecMcUdp = new MelsecMcUdp(param.IpAdress, param.Port);
                                connect = this._MelsecMcUdp.RemoteRun();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecMcUdp;
                                    LoggerHelper.Info("三菱PLC" + param.IpAdress + "打开成功");
                                }
                                else
                                {
                    ...
                    case enUserConnectType.SerialPort:
                        switch (param.DeviceModel)
                        {
                            case enDeviceModel.MelsecA3CNet:
                                this._MelsecA3CNet?.Close();
                                this._MelsecA3CNet = new MelsecA3CNet();
                                this._MelsecA3CNet.SerialPortInni(param.PortName, param.BaudRate, param.DataBits, param.StopBits, param.Parity);
                                OperateResult connect = this._MelsecA3CNet.Open();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecA3CNet;
                                    LoggerHelper.Info("三菱PLC" + param.PortName + "打开成功");
                                }
                                else
                                {
                                    result = false;
                                    LoggerHelper.Warn("三菱PLC" + param.PortName + "打开失败");
                                }
                                break;
                            case enDeviceModel.MelsecFxLinks:
                                this._MelsecFxLinks?.Close();
                                this._MelsecFxLinks = new MelsecFxLinks();
                                this._MelsecFxLinks.SerialPortInni(param.PortName, param.BaudRate, param.DataBits, param.StopBits, param.Parity);
                                connect = this._MelsecFxLinks.Open();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecFxLinks;
                                    LoggerHelper.Info("三菱PLC" + param.PortName + "打开成功");
                                }
                                else
                                {
                                ...
                                break;
                            case enDeviceModel.MelsecFxSerial:
                                this._MelsecFxSerial?.Close();
                                this._MelsecFxSerial = new MelsecFxSerial();
                                this._MelsecFxSerial.SerialPortInni(param.PortName, param.BaudRate, param.DataBits, param.StopBits, param.Parity);
                                connect = this._MelsecFxSerial.Open();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._MelsecFxSerial;
                                    LoggerHelper.Info("三菱PLC" + param.PortName + "打开成功");
                                }
                                else
                                {
