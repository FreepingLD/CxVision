...
{
    public class ModbusTcpClient : MotionBase
    {
        private string sign = "ModbusTcp";
                    ...
                    case enUserConnectType.TcpIp:
                        ...
                        switch (param.DeviceModel)
                        {
                            ...
                            case enDeviceModel.ModbusTcpClient:
                                this._modbusTcpNet?.ConnectClose();
                                this._modbusTcpNet = new ModbusTcpNet(param.IpAdress, param.Port);
                                connect = this._modbusTcpNet.ConnectServer();
                                if (connect.IsSuccess)
                                {
                                    result = true;
                                    this._readWriteNet = this._modbusTcpNet;
