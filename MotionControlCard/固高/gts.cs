...
namespace MotionControlCard
{
	...
	public struct TCrdFollowPrm
	{
        ...
        [DllImport("gts.dll")]
        public static extern short GT_SetAuDac(short dac,ref short pValue,short count);
        [DllImport("gts.dll")]
        public static extern short GT_GetAuDac(short dac, out short value, short count, out uint pClock);
        ...
        [DllImport("gts.dll")]
        public static extern short GT_WriteAuEncPos(short encoder,ref double pPos,short count);
        [DllImport("gts.dll")]
        public static extern short GT_ReadAuEncPos(short encoder,out double pPos,short count);
        [DllImport("gts.dll")]
        public static extern short GT_ReadAuEncVel(short encoder,out double pVel,short count);

        [DllImport("gts.dll")]
        public static extern short GT_WriteMpgPos(short mpg,ref double pPos,short count);
	    ...
	    [DllImport("gts.dll")]
        public static extern short GT_ReadMpgInfo(short mpg,out TMpgInfo pMpgInfo);
        ...
        [DllImport("gts.dll")]
        public static extern short GT_StopEx(long mask, int option);
        [DllImport("gts.dll")]
