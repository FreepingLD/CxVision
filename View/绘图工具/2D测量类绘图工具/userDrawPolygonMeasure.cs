...
{
    [Serializable]
    public class userDrawPolygonMeasure : DrawingBaseMeasure //DrawingBaseMeasure
    {
        ...
        public userDrawPolygonMeasure(HWindowControl hWindowControl, bool appendContextMenuStrip) : base(hWindowControl, appendContextMenuStrip)
        {

        }
        public userDrawPolygonMeasure(HWindowControl hWindowControl, userPixPolygon pixPolygon) : base(hWindowControl)
        {
    ...
    public class PixPolygon2Mea
    {
        ...
        public PixPolygon2Mea(double[] rows, double[] cols)
        {
            this.RectRow = new List<double>();
            this.RectCol = new List<double>();
            this.CircleRow = new List<double>();
        ...
        public PixPolygon2Mea(userPixRectangle1 pixRectangle1)
        {
            this.RectRow = new List<double>();
            this.RectCol = new List<double>();
            this.CircleRow = new List<double>();
