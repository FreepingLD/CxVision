...
{
    [Serializable]
    public class userDrawManualCircleMeasure : DrawingBaseMeasure
    {
        ...
        public userDrawManualCircleMeasure(HWindowControl hWindowControl) : base(hWindowControl)
        {

        }

        public userDrawManualCircleMeasure(HWindowControl hWindowControl, userWcsCircle wcsCircle, userWcsCoordSystem wcsCoordSystem) : base(hWindowControl)
        {
        ...
        public userDrawManualCircleMeasure(HWindowControl hWindowControl, userPixCircle pixCircle, userPixCoordSystem pixCoordSystem) : base(hWindowControl)
        {
        ...
        public userDrawManualCircleMeasure(HWindowControl hWindowControl, userWcsCircle wcsCircle) : base(hWindowControl)
        {
            this.wcsCoordSystem = new userWcsCoordSystem();
            ////////////////////
            if (wcsCircle != null && wcsCircle.CamParams != null)// 等于null表示是第一次使用，否则则不是第一次使用
        ...
        public userDrawManualCircleMeasure(HWindowControl hWindowControl, userPixCircle pixCircle) : base(hWindowControl)
        {
            this.pixCoordSystem = new userPixCoordSystem();
            ////////////////////
            if (pixCircle != null && pixCircle.CamParams != null)// 等于null表示是第一次使用，否则则不是第一次使用
