...
{
    [Serializable]
    public class userDrawManualPolygonMeasure : DrawingBaseMeasure //DrawingBaseMeasure
    {
        ...
        public userDrawManualPolygonMeasure(HWindowControl hWindowControl, bool appendContextMenuStrip) : base(hWindowControl, appendContextMenuStrip)
        {

        }
        public userDrawManualPolygonMeasure(HWindowControl hWindowControl, userPixPolygon pixPolygon, userPixCoordSystem pixCoordSystem) : base(hWindowControl)
        {
                ...
                if (this.isDrwingObject)
                {
                    switch (pos)
                    {
                        case PosSizableRect.FirstNode:
                            if (pixPolygon.RectRow.Count > 0)
                            {
                                this.AttachDrawingPropertyData.Add(new ViewData(CreateRectSizableNode(pixPolygon.RectCol[0], pixPolygon.RectRow[0]), "yellow"));
                            }
                            break;
