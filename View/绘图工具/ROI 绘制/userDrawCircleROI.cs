...
namespace View
{
    ...
    public class userDrawCircleROI : VisualizeView
    {
        ...
        public override void DrawWcsRoiShapeOnWindow(enColor color, out WcsROI roi)
        {
            ...
            this.isDisplayHImageData = true;
            this.CurrentButton = MouseButtons.None;
            roi = this.GetDrawWcsCircleParam();
            this.DetachDrawingObjectFromWindow();
        }
        ...
        public drawWcsCircle GetDrawWcsCircleParam()
        {
            drawPixCircle circlePixPosition = new drawPixCircle(this.pixCircle.Row, this.pixCircle.Col, this.pixCircle.Radius);
            drawWcsCircle wcsCircle = circlePixPosition.GetWcsCircle(this.CameraParam);
            wcsCircle = wcsCircle.AffineTransWcsCircle(this.wcsCoordSystem?.GetInvertVariationHomMat2D()); // 变换为之前的
            return wcsCircle;
        }
