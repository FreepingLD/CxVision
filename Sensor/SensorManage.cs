...
namespace Sensor
{
    ...
    public class SensorManage
    {
        ...
        public void Connect()
        {
                ...
                foreach (var item in listConfigPara)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            new UserMessageForm().ShowDialog("传感器：" + item.SensorName + " 打开失败", "打开传感器");
                        }
                    ...
                    {
                        new UserMessageForm().ShowDialog("传感器：" + item.SensorName + " 打开报错" + ex.ToString(), " 打开传感器");
            ...
            {
                new UserMessageForm().ShowDialog("打开传感器报错" + ex.ToString(), " 打开传感器");
