...
{
    public partial class VectorAlignForm : Form
    {
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        private TreeNode _refNode;
        public VectorAlignForm(IFunction function)
        {
        ...
        public VectorAlignForm(TreeNode node)
        {
            this._refNode = node;
        ...
        private void VectorAlignForm_Load(object sender, EventArgs e)
        {
            ...
            {
                userWcsVector wcsCurVector = ((VectorAlign)this._function).PlateCurVector.GetWcsVector();
                userWcsVector wcsVector = ((VectorAlign)this._function).PlateTeachVector.GetWcsVector(wcsCurVector.Grab_x, wcsCurVector.Grab_y);
            ...
            {
                userWcsVector wcsCurVector = ((VectorAlign)this._function).BandCurVector.GetWcsVector();
                userWcsVector wcsVector = ((VectorAlign)this._function).BandTeachVector.GetWcsVector(wcsCurVector.Grab_x, wcsCurVector.Grab_y);
        ...
        private void VectorAlignForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        {
            VectorAlignForm_MouseDown(null, null);  // 用标签鼠标按下事件来代替窗体鼠标按下事件
        }
