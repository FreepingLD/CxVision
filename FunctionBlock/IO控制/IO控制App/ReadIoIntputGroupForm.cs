...
{
    public partial class ReadIoIntputGroupForm : Form
    {
        private CancellationTokenSource cts;
        private Form form;
        private IFunction _function;
        private bool isFormClose = false;
        public ReadIoIntputGroupForm(IFunction function)
        {
        ...
        private void ReadIoIntputGroupForm_Load(object sender, EventArgs e)
        {
            BindProperty();
        ...
        private void BindProperty()
        {
            ...
            {
                ////////////////
                this.dataGridView1.DataSource = ((ReadIoIntputGroup)this._function).LevelDataTable;
                ...
                //////////////////
                this.控制卡comboBox.DataBindings.Add("SelectedItem", ((ReadIoIntputGroup)this._function), "Card", true, DataSourceUpdateMode.OnPropertyChanged); //WaiteTime;
                this.IO端口类型comboBox.DataBindings.Add("Text", (ReadIoIntputGroup)this._function, "IoPortType", true, DataSourceUpdateMode.OnPropertyChanged);
                ////////////////////
                this.IO端口numericUpDown.DataBindings.Add("Value", ((ReadIoIntputGroup)this._function), "IoInputGroup", true, DataSourceUpdateMode.OnPropertyChanged);
                this.IO端口电平numericUpDown.DataBindings.Add("Value", ((ReadIoIntputGroup)this._function), "IoInputlevel", true, DataSourceUpdateMode.OnPropertyChanged);  
            }
            catch (Exception ee)
            {
