...
{
    public partial class ReadIoOutputBitForm : Form
    {
        private CancellationTokenSource cts;
        private Form form;
        private IFunction _function;
        private bool isFormClose = false;
        public ReadIoOutputBitForm(IFunction function)
        {
        ...
        private void ReadIoOutputBitForm_Load(object sender, EventArgs e)
        {
            BindProperty();
        ...
        private void BindProperty()
        {
            ...
            {
                ////////////////
                this.dataGridView1.DataSource = ((ReadIoOutputBit)this._function).LevelDataTable;
                ...
                //////////////////
                this.控制卡comboBox.DataBindings.Add("SelectedItem", ((ReadIoOutputBit)this._function), "Card", true, DataSourceUpdateMode.OnPropertyChanged); //WaiteTime;
                this.IO端口类型comboBox.DataBindings.Add("Text", (ReadIoOutputBit)this._function, "IoPortType", true, DataSourceUpdateMode.OnPropertyChanged);
                ////////////////////
                this.IO端口numericUpDown.DataBindings.Add("Value", ((ReadIoOutputBit)this._function), "IoOutputPort", true, DataSourceUpdateMode.OnPropertyChanged);
                this.IO端口电平numericUpDown.DataBindings.Add("Value", ((ReadIoOutputBit)this._function), "IoOutputLevel", true, DataSourceUpdateMode.OnPropertyChanged);  
            }
            catch (Exception ee)
            {
