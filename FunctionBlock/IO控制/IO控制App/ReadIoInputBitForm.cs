...
{
    public partial class ReadIoInputBitForm : Form
    {
        private CancellationTokenSource cts;
        private Form form;
        private IFunction _function;
        private bool isFormClose = false;
        public ReadIoInputBitForm(IFunction function)
        {
        ...
        private void ReadIoInputBitForm_Load(object sender, EventArgs e)
        {
            BindProperty();
        ...
        private void BindProperty()
        {
            ...
            {
                ////////////////
                this.dataGridView1.DataSource = ((ReadIoInputBit)this._function).LevelDataTable;
                ...
                //////////////////
                this.控制卡comboBox.DataBindings.Add("SelectedItem", ((ReadIoInputBit)this._function), "Card", true, DataSourceUpdateMode.OnPropertyChanged); //WaiteTime;
                this.IO端口类型comboBox.DataBindings.Add("Text", (ReadIoInputBit)this._function, "IoPortType", true, DataSourceUpdateMode.OnPropertyChanged);
                ////////////////////
                this.IO端口numericUpDown.DataBindings.Add("Value", ((ReadIoInputBit)this._function), "IoInputPort", true, DataSourceUpdateMode.OnPropertyChanged);
                this.IO端口电平numericUpDown.DataBindings.Add("Value", ((ReadIoInputBit)this._function), "IoInputlevel", true, DataSourceUpdateMode.OnPropertyChanged);  
            }
            catch (Exception ee)
            {
