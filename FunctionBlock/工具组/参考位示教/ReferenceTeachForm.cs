...
{
    public partial class ReferenceTeachForm : Form
    {
        ...
        private ReferenceTeach _referenceTeach;
        ...
        public ReferenceTeachForm(IFunction function)
        {
            InitializeComponent();
            ...
            this._referenceTeach = (ReferenceTeach)function;
        }
        public ReferenceTeachForm(TreeNode node, ImageDataClass imageData = null, string treeViewName = null)
        {
            InitializeComponent();
            this._refNode = node;
            this._function = (IFunction)this._refNode.Tag;
            this.drawObject = new DrawingBaseMeasure(this.hWindowControl1, true);
            this.treeViewWrapClass = new TreeViewWrapClass(this.treeView1, this);
            this.drawObject.BackImage = imageData;
            this._referenceTeach = (ReferenceTeach)this._function;
            this._referenceTeach.EnableEdite = true;
        ...
        private void ReferenceTeachForm_Load(object sender, EventArgs e)
        {
            ...
            //AddForm(this.panel1, this.metrolegyParamForm);
            //////////////////////////////////////////////////////////////////
        ...
        public void LoadTreeNode()
        {
            ...
            {
                //if (item.Tag != null && ((BaseFunction)item.Tag).IsVisualNode)
        ...
        private void BindProperty()
        {
            try
            {
                //AddForm(this.panel1, new MetrolegyParamForm());
            }
            catch (Exception ex)
            {
        ...
        private void ReferenceTeachForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                this._referenceTeach.EnableEdite = false;
            ...
            try
            {
                ...
                switch (name)
                {
                    ...
                    case "保存配置toolStripButton":
                        ...
                        //((ReferenceTeach)_refNode.Tag).ParentNode = _refNode;
                        break;
        ...
        {
            ReferenceTeachForm_MouseDown(null, null);
        }
        ...
        private void ReferenceTeachForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
