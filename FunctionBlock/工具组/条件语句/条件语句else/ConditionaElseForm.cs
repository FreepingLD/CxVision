...
namespace FunctionBlock
{
    public partial class ConditionaElseForm : Form
    {
        ...
        public ConditionaElseForm(TreeNode node, string treeViewName = null)
        {
        ...
        {
            ConditionaElseForm_MouseDown(null, null);
        }
        ...
        private void ConditionaElseForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
