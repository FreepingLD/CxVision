...
{
    public partial class ConditionaIfForm : Form
    {
        ...
        private ConditionaIf _ForLoopControl;
        ...
        public ConditionaIfForm(IFunction function)
        {
            ...
            this._ForLoopControl = (ConditionaIf)this._function;
            this.metrolegyParamForm = new MetrolegyParamForm(this.drawObject);
        }
        public ConditionaIfForm(TreeNode node, string treeViewName = null)
        {
        ...
        private void ConditionaIfForm_Load(object sender, EventArgs e)
        {
        ...
        private void ConcurrentExecutionForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                ((ConditionaIf)_refNode.Tag).ParentNode = _refNode;
        ...
        {
            ConditionaIfForm_MouseDown(null, null);
        }
        ...
        private void ConditionaIfForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
