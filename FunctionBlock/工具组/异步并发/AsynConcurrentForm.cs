...
{
    public partial class AsynConcurrentForm : Form
    {
        ...
        private AsynConcurrent _ConcurrentExecution;
        ...
        public AsynConcurrentForm(IFunction function)
        {
        ...
        public AsynConcurrentForm(TreeNode node)
        {
        ...
        private void ConcurrentExecutionForm_Load(object sender, EventArgs e)
        {
            ...
            this.LoadTreeNode();
            ///////////////////////////////////////////////
            this.数据读取dataGridView.DataSource = ((AsynConcurrent)this._function).PlcInfo;
        ...
        {
            AsynConcurrentForm_MouseDown(null, null);
        }
        ...
        private void AsynConcurrentForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
