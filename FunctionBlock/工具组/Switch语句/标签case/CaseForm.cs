...
namespace FunctionBlock
{
    public partial class CaseForm : Form
    {
        ...
        public CaseForm(IFunction function)
        {
            ...
            this._ForLoopControl = (Case)this._function;
            this.metrolegyParamForm = new MetrolegyParamForm(this.drawObject);
        }
        public CaseForm(TreeNode node, string treeViewName = null)
        {
        ...
        private void ConditionaCaseForm_Load(object sender, EventArgs e)
        {
        ...
        private void BindProperty()
        {
            try
            {
                this.标签textBox.DataBindings.Add("Text", ((Case)this._function), "Sign", true, DataSourceUpdateMode.OnPropertyChanged);
                this.执行方式comboBox.DataBindings.Add("Text", ((Case)this._function), "Method", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch
            {
