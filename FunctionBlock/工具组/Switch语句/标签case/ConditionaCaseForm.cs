...
{
    public partial class ConditionaCaseForm : Form
    {
        private Form form;
        ...
        private ConditionaCase _ForLoopControl;
        ...
        public ConditionaCaseForm(IFunction function)
        {
            ...
            this._ForLoopControl = (ConditionaCase)this._function;
            this.metrolegyParamForm = new MetrolegyParamForm(this.drawObject);
        }
        public ConditionaCaseForm(TreeNode node)
        {       
        ...
        private void ConcurrentExecutionForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                ((ConditionaCase)_refNode.Tag).ParentNode = _refNode;
