...
{
    public partial class ConditionaSwitchlForm : Form
    {
        private Form form;
        ...
        private ConditionalSwitch _ForLoopControl;
        ...
        public ConditionaSwitchlForm(IFunction function)
        {
            ...
            this._ForLoopControl = (ConditionalSwitch)this._function;
            this.metrolegyParamForm = new MetrolegyParamForm(this.drawObject);
        }
        public ConditionaSwitchlForm(TreeNode node)
        {       
        ...
        private void ConcurrentExecutionForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                ((ConditionalSwitch)_refNode.Tag).ParentNode = _refNode;
