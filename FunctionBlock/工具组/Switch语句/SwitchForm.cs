...
namespace FunctionBlock
{
    public partial class SwitchForm : Form
    {
        ...
        private Switch _ForLoopControl;
        ...
        public SwitchForm(IFunction function)
        {
        ...
        public SwitchForm(TreeNode node, string treeViewName = null)
        {       
        ...
        private void SwitchForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                ((Switch)_refNode.Tag).ParentNode = _refNode;
        ...
        private void 数据读取dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    BindingList<ReadDataCommand> readDataList = ((BindingList<ReadDataCommand>)((Switch)this._function).PlcInfo);
        ...
        #endregion
        private void SwitchForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        {
            SwitchForm_MouseDown(null, null);  // 用标签鼠标按下事件来代替窗体鼠标按下事件
        }
