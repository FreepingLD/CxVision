...
{
    public partial class JobUnitForm : Form
    {
        ...
        public JobUnitForm(IFunction function)
        {
        ...
        public JobUnitForm(TreeNode node, ImageDataClass imageData, string treeViewName = null)
        {
            InitializeComponent();
            this._refNode = node;
