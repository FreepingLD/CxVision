...
{
    public partial class JobUnitFormOld : Form
    {
        ...
        private JobUnit _FeatureLocalization;
        ...
        public JobUnitFormOld(IFunction function)
        {
            ...
            this._FeatureLocalization = (JobUnit)function;
        }
        public JobUnitFormOld(TreeNode node,ImageDataClass imageData, string treeViewName = null)
        {
            InitializeComponent();
            this._refNode = node;
            ...
            this._FeatureLocalization = (JobUnit)this._function;
        ...
        private void JobUnitForm_Load(object sender, EventArgs e)
        {
            ...
            /////////////////////////////////////////////
            this.数据读取dataGridView.DataSource = ((JobUnit)this._function).ResultInfo;
            //this.dataGridView1.DataSource = ((JobUnit)this._function).MeasInfo;
        ...
        private void JobUnitForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                /// 转移节点到主面板上来
        ...
        private void 数据读取dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    ...
                    BindingList<PlcCommunicateInfo> ReadDataList = (BindingList<PlcCommunicateInfo>)((JobUnit)this._function).ResultInfo;
        ...
        {
            JobUnitForm_MouseDown(null, null);
        }
        ...
        private void JobUnitForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
