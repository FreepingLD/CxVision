...
{
    public partial class FeatureLocalizationForm : Form
    {
        ...
        private FeatureLocalization _FeatureLocalization;
        ...
        public FeatureLocalizationForm(IFunction function)
        {
            ...
            this._FeatureLocalization = (FeatureLocalization)function;
        }
        public FeatureLocalizationForm(TreeNode node, ImageDataClass imageData = null, string treeViewName = null)
        {
            this._refNode = node;
            ...
            this._FeatureLocalization = (FeatureLocalization)this._function;
            //this.Text = node.Text;
        ...
        private void FeatureLocalizationForm_Load(object sender, EventArgs e)
        {
            // 注册事件
            ...
            //this.DataType.ValueType = typeof(enDataTypes);
            //foreach (enDataTypes item in Enum.GetValues(typeof(enDataTypes)))
            //    this.DataType.Items.Add(item);
            //////////////////////////////////////////////
            ...
            ////////////////////////////////////////////
            //this.PLC信息dataGridView.DataSource = ((AlignmentGuidedCalculation)this._function).PLcInfo;
            //////////////////////////////////////////
            this.LoadTreeNode();//
        ...
        private void 运行工具条toolStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            try
            {
                ...
                switch (name)
                {
                    ...
                    //case nameof(this.定位示教toolStripButton):
