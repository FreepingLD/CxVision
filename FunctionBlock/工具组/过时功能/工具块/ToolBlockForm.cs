...
namespace FunctionBlock
{
    public partial class ToolBlockForm : Form
    {
        ...
        private ToolBlock _FeatureLocalization;
        ...
        public ToolBlockForm(IFunction function)
        {
            ...
            this._FeatureLocalization = (ToolBlock)function;
        }
        public ToolBlockForm(TreeNode node)
        {
            this._refNode = node;
            ...
            this.drawObject = new DrawingBaseMeasure(this.hWindowControl1, true);
            this.treeViewWrapClass = new TreeViewWrapClass(this.treeView1, this);
            this._FeatureLocalization = (ToolBlock)this._function;
            this.Text = node.Text;
        ...
        private void ToolBlockForm_Load(object sender, EventArgs e)
        {
            ...
            ///////////////////////////////////
            //this.ReadWriteState.Items.Clear();
            //this.ReadWriteState.ValueType = typeof(enAxisReadWriteState);
            //foreach (enAxisReadWriteState item in Enum.GetValues(typeof(enAxisReadWriteState)))
            //    this.ReadWriteState.Items.Add(item);
            ////////////////////////////////////
