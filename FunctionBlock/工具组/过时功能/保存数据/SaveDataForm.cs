...
namespace FunctionBlock
{
    public partial class SaveDataForm : Form
    {
        ...
        public SaveDataForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.写入模式comboBox.DataSource = Enum.GetNames(typeof(enWriteMode));
                SaveDataParam param = ((SaveData)this._function).SaveParam;
                this.文件目录textBox.DataBindings.Add("Text", param, nameof(param.FolderPath), true, DataSourceUpdateMode.OnPropertyChanged);
                ...
                this.文件名称TextBox.DataBindings.Add("Text", param, nameof(param.FileName), true, DataSourceUpdateMode.OnPropertyChanged);
                this.写入模式comboBox.DataBindings.Add("Text", param, nameof(param.WriteMode), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
