...
{
    public partial class DefectDetectingForm : Form
    {
        ...
        private DefectDetecting _DefectDetecting;
        ...
        public DefectDetectingForm(IFunction function)
        {
            ...
            this._DefectDetecting = (DefectDetecting)function;
        }
        public DefectDetectingForm(TreeNode node)
        {
            this._refNode = node;
            ...
            this.drawObject = new DrawingBaseMeasure(this.hWindowControl1, true);
            this.treeViewWrapClass = new TreeViewWrapClass(this.treeView1, this);
            this._DefectDetecting = (DefectDetecting)this._function;
            this.Text = node.Text;
            this.treeViewWrapClass.ToolName = this._refNode.Name.Replace(".Tool", "");
        }
        public DefectDetectingForm(TreeNode node, ImageDataClass imageData)
        {
            this._refNode = node;
            this._function = (IFunction)node.Tag;
        ...
        private void DefectDetectingForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.采集源comboBox.DataBindings.Add("Text", this._DefectDetecting, nameof(this._DefectDetecting.AcqSourceName), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void FeatureLocalizationForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                //((DefectDetecting)_refNode.Tag).ParentNode = _refNode;
                /////////////
