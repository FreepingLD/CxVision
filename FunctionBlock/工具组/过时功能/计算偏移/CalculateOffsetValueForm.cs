...
{
    public partial class CalculateOffsetValueForm : Form
    {
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        private TreeNode _refNode;
        public CalculateOffsetValueForm(IFunction function)
        {
        ...
        public CalculateOffsetValueForm(TreeNode node)
        {
            this._refNode = node;
        ...
        private void CalculateOffsetValueForm_Load(object sender, EventArgs e)
        {
            ...
            {
                foreach (var item in ((CalculateOffsetValue)this._function).RefPoint)
                {
            ...
            {
                foreach (var item in ((CalculateOffsetValue)this._function).CurPoint)
                {
        ...
        private void BindProperty()
        {
            try
            {
                CompensationParam param = ((CalculateOffsetValue)this._function).Param;
    ...
    public class TempPoint
    {
        ...
        public TempPoint(double x, double y, double angle)
        {
            this.X = x;
            this.Y = y;
            this.Z = angle;
