...
{
    public partial class ThicknessMeasureForm : Form
    {
        ...
        private ThicknessMeasure _ThicknessMeasure;
        ...
        public ThicknessMeasureForm(IFunction function)
        {
            ...
            this._ThicknessMeasure = (ThicknessMeasure)function;
        }
        public ThicknessMeasureForm(TreeNode node)
        {
            this._refNode = node;
            ...
            this.drawObject = new DrawingBaseMeasure(this.hWindowControl1, true);
            this.treeViewWrapClass = new TreeViewWrapClass(this.treeView1, this);
            this._ThicknessMeasure = (ThicknessMeasure)this._function;
            this.Text = node.Text;
            this.treeViewWrapClass.ToolName = this._refNode.Name.Replace(".Tool", "");
        }

        private void ThicknessMeasureForm_Load(object sender, EventArgs e)
        {
            // 注册事件
