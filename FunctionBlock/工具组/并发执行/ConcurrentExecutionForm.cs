...
namespace FunctionBlock
{
    public partial class ConcurrentExecutionForm : Form
    {
        ...
        public ConcurrentExecutionForm(TreeNode node, ImageDataClass imageData = null, string treeViewName = null)
        {
        ...
        {
            ConcurrentExecutionForm_MouseDown(null, null);
        }
        ...
        private void ConcurrentExecutionForm_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
