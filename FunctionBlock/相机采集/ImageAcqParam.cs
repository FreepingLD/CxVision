...
namespace FunctionBlock
{
    ...
    public class ImageAcqParam
    {
        ...
        public ImageAcqParam()
        {
            ...
            this.SingleFilePath = "";
            this.FolderPath = "";
            this.GrabPoint = new userWcsVector(0, 0, 0, 0);
        ...
        public ImageDataClass ReadImage(string path, string acqSourceName)
        {
            if (File.Exists(path))
            {
                ...
                InitCamParam(image);
                return new ImageDataClass(image, this.camParam, this.camParam.ImageIndex);
            }
            return null;
        }
        ...
        private void InitCamParam(HImage image)
        {
            ...
            else
            {
                ...
                //this.camParam = new CameraParam();
                NinePointCalibParam.HHomMat2DToCamparaCamPos(this.camParam.HomMat2D.GetHHomMat(), width, height, this.camParam.PixScale, out camParam, out camPose, out Quality);
