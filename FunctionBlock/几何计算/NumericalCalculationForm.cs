...
{
    public partial class NumericalCalculationForm : Form
    {
        ...
        public NumericalCalculationForm(IFunction function,TreeNode node)
        {
        ...
        private void NumericalCalculationForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                //this.结果dataGridView.DataSource = ((FunctionBlock.NumericalCalculation)this._function).ResultDataTable;
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.NumericalCalculation.enShowItems));
                this.计算方法comboBox.DataSource = Enum.GetNames(typeof(enOperateMethod));
                //////////////////////////////
                this.计算方法comboBox.DataBindings.Add("Text", (FunctionBlock.NumericalCalculation)this._function, "OperateMethod", true, DataSourceUpdateMode.OnPropertyChanged);
                //////////////
                this.标准值textBox.DataBindings.Add("Text", (FunctionBlock.NumericalCalculation)this._function, "StdValue", true, DataSourceUpdateMode.OnPropertyChanged);
                this.上公差textBox.DataBindings.Add("Text", (FunctionBlock.NumericalCalculation)this._function, "UpTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                this.下公差textBox.DataBindings.Add("Text", (FunctionBlock.NumericalCalculation)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void NumericalCalculationForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            // 注消事件
            try
            {
