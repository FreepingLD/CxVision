namespace FunctionBlock
{
    partial class ContourSendForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ContourSendForm));
            this.tableLayoutPanel1 = new System.Windows.Forms.TableLayoutPanel();
            this.tabControl1 = new System.Windows.Forms.TabControl();
            this.tabPage1 = new System.Windows.Forms.TabPage();
            this.tableLayoutPanel2 = new System.Windows.Forms.TableLayoutPanel();
            this.groupBox3 = new System.Windows.Forms.GroupBox();
            this.插值参数textBox = new System.Windows.Forms.TextBox();
            this.插值方式comboBox = new System.Windows.Forms.ComboBox();
            this.label10 = new System.Windows.Forms.Label();
            this.label11 = new System.Windows.Forms.Label();
            this.groupBox2 = new System.Windows.Forms.GroupBox();
            this.角度方向comboBox = new System.Windows.Forms.ComboBox();
            this.label9 = new System.Windows.Forms.Label();
            this.角度取反checkBox = new System.Windows.Forms.CheckBox();
            this.启用C角计算checkBox = new System.Windows.Forms.CheckBox();
            this.初始角度comboBox = new System.Windows.Forms.ComboBox();
            this.label5 = new System.Windows.Forms.Label();
            this.角度偏移comboBox = new System.Windows.Forms.ComboBox();
            this.角度顺序comboBox = new System.Windows.Forms.ComboBox();
            this.label7 = new System.Windows.Forms.Label();
            this.label8 = new System.Windows.Forms.Label();
            this.groupBox1 = new System.Windows.Forms.GroupBox();
            this.listBox1 = new System.Windows.Forms.ListBox();
            this.参数groupBox = new System.Windows.Forms.GroupBox();
            this.长度地址comboBox = new System.Windows.Forms.ComboBox();
            this.label4 = new System.Windows.Forms.Label();
            this.接收地址comboBox = new System.Windows.Forms.ComboBox();
            ...
            // groupBox3
            // 
            this.groupBox3.Controls.Add(this.插值参数textBox);
            this.groupBox3.Controls.Add(this.插值方式comboBox);
            ...
            // 插值参数textBox
            // 
            this.插值参数textBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            ...
            this.label11.Text = "插值参数：";
            // 
            // groupBox2
            // 
            this.groupBox2.Controls.Add(this.角度方向comboBox);
            this.groupBox2.Controls.Add(this.label9);
            this.groupBox2.Controls.Add(this.角度取反checkBox);
            this.groupBox2.Controls.Add(this.启用C角计算checkBox);
            this.groupBox2.Controls.Add(this.初始角度comboBox);
            this.groupBox2.Controls.Add(this.label5);
            this.groupBox2.Controls.Add(this.角度偏移comboBox);
            this.groupBox2.Controls.Add(this.角度顺序comboBox);
            ...
            // 角度方向comboBox
            // 
            this.角度方向comboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.角度方向comboBox.FormattingEnabled = true;
            this.角度方向comboBox.Items.AddRange(new object[] {
            "向外",
            "向内"});
            ...
            this.label9.Text = "角度方向：";
            // 
            // 角度取反checkBox
            // 
            this.角度取反checkBox.AutoSize = true;
            this.角度取反checkBox.Location = new System.Drawing.Point(195, 22);
            this.角度取反checkBox.Name = "角度取反checkBox";
            this.角度取反checkBox.Size = new System.Drawing.Size(72, 16);
            this.角度取反checkBox.TabIndex = 25;
            this.角度取反checkBox.Text = "角度取反";
            this.角度取反checkBox.UseVisualStyleBackColor = true;
            // 
            // 启用C角计算checkBox
            // 
            this.启用C角计算checkBox.AutoSize = true;
            this.启用C角计算checkBox.Location = new System.Drawing.Point(97, 22);
            this.启用C角计算checkBox.Name = "启用C角计算checkBox";
            this.启用C角计算checkBox.Size = new System.Drawing.Size(90, 16);
            this.启用C角计算checkBox.TabIndex = 24;
            this.启用C角计算checkBox.Text = "启用C角计算";
            this.启用C角计算checkBox.UseVisualStyleBackColor = true;
            // 
            // 初始角度comboBox
            // 
            this.初始角度comboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.初始角度comboBox.FormattingEnabled = true;
            this.初始角度comboBox.Items.AddRange(new object[] {
            "0",
            "90",
            "180",
            "270",
            ...
            this.label5.Text = "初始角度：";
            // 
            // 角度偏移comboBox
            // 
            this.角度偏移comboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.角度偏移comboBox.FormattingEnabled = true;
            this.角度偏移comboBox.Items.AddRange(new object[] {
            "0",
            "90",
            "180",
            "270",
            ...
            // 角度顺序comboBox
            // 
            this.角度顺序comboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.角度顺序comboBox.FormattingEnabled = true;
            this.角度顺序comboBox.Items.AddRange(new object[] {
            "NONE",
            "逆时针",
            "顺时针"});
            ...
            // 参数groupBox
            // 
            this.参数groupBox.Controls.Add(this.长度地址comboBox);
            this.参数groupBox.Controls.Add(this.label4);
            this.参数groupBox.Controls.Add(this.接收地址comboBox);
            this.参数groupBox.Controls.Add(this.label3);
            this.参数groupBox.Controls.Add(this.坐标系名称comboBox);
            this.参数groupBox.Controls.Add(this.视图窗口comboBox);
            ...
            // 长度地址comboBox
            // 
            this.长度地址comboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.label4.Text = "轨迹长度地址：";
            // 
            // 接收地址comboBox
            // 
            this.接收地址comboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.Tag = "1920,1080";
            this.Text = "轮廓发送";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ContourSendForm_FormClosing);
            this.Load += new System.EventHandler(this.ContourSendForm_Load);
        ...
        private System.Windows.Forms.ComboBox 接收地址comboBox;
        private System.Windows.Forms.Label label3;
        private System.Windows.Forms.GroupBox groupBox2;
        private System.Windows.Forms.ComboBox 初始角度comboBox;
        private System.Windows.Forms.Label label5;
        private System.Windows.Forms.ComboBox 角度偏移comboBox;
        private System.Windows.Forms.ComboBox 角度顺序comboBox;
        private System.Windows.Forms.Label label7;
        private System.Windows.Forms.Label label8;
        private System.Windows.Forms.ComboBox 长度地址comboBox;
        private System.Windows.Forms.Label label4;
        private System.Windows.Forms.CheckBox 启用C角计算checkBox;
        private System.Windows.Forms.CheckBox 角度取反checkBox;
        private System.Windows.Forms.GroupBox groupBox3;
        private System.Windows.Forms.ComboBox 插值方式comboBox;
        private System.Windows.Forms.Label label10;
        private System.Windows.Forms.Label label11;
        private System.Windows.Forms.ComboBox 角度方向comboBox;
        private System.Windows.Forms.Label label9;
        private System.Windows.Forms.TextBox 插值参数textBox;
    }
}