...
namespace FunctionBlock
{
    ...
    public class TrackStack : BaseFunction, IFunction
    {
        ...
        public TrackStackParam StackParam { get; set; }
        ...
        public TrackStack(string acqSourceName)
        {
            this.StackParam = new TrackStackParam();
            InitBindingTable();
        }
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                this.Result.Succss = TrackStackMethod.StackTrack(this.TrackPoint,this.StackParam,out this._wcsPolyLine);
                ///////////////////////////////////////////////
                stopwatch.Stop();
