...
namespace FunctionBlock
{
    ...
    public class TrackSelfCheck : BaseFunction, IFunction
    {
        ...
        public TrackSelfCheckParam SelfCheckParam { get; set; }
        ...
        public TrackSelfCheck(string acqSourceName)
        {
            this.SelfCheckParam = new TrackSelfCheckParam();
            this.ResultInfo = new BindingList<OcrResultInfo>();
        }

        public TrackSelfCheck()
        {
            this.SelfCheckParam = new TrackSelfCheckParam();
            this.ResultInfo = new BindingList<OcrResultInfo>();
        }
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                this.Result.Succss = TrackSelfCheckMethod.TrackSelfCheck(this.CurTrackPoint, this.StdTrackPoint,0.2, 0.7, enTransformationType.rigid,out this._wcsPolyLine,out this._dataError);
                //TrackSelfCheckMethod.TrackPointRemove(this.CurTrackPoint, 6, out this._wcsPolyLine);
                ///////////////////////////////////////////////
                stopwatch.Stop();
                ...
                ((BindingList<OcrResultInfo>)this.ResultInfo)[3].SetValue(this.name, "误差", string.Join(",", this._dataError));
