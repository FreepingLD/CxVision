...
{
    public partial class LineOffsetForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public LineOffsetForm(IFunction function)
        {
            InitializeComponent();
        ...
        public LineOffsetForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                //this.结果dataGridView.DataSource = ((LineOffset)this._function).ResultInfo;
                LineOffsetParam offsetParam = ((LineOffset)this._function).OffsetParam;
