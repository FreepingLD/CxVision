...
{
    public partial class LineExtendForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public LineExtendForm(IFunction function)
        {
            InitializeComponent();
        ...
        public LineExtendForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        public void LineExtendForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(enExtendMethod));
                LineExtendParam offsetParam = ((LineExtend)this._function).ExtendParam;
                this.延抻方式comboBox.DataBindings.Add("Text", offsetParam, nameof(offsetParam.ExtendMethod), true, DataSourceUpdateMode.OnPropertyChanged);
                this.延抻距离comboBox.DataBindings.Add("Text", offsetParam, nameof(offsetParam.ExtendDist), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
