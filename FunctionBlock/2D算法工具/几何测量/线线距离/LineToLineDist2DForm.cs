...
{
    public partial class LineToLineDist2DForm : Form
    {
        private IFunction _function;
        private VisualizeView drawObject;
        public LineToLineDist2DForm(IFunction function,TreeNode node)
        {      
        ...
        private void LineToLineDist2DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.结果dataGridView.DataSource = ((FunctionBlock.LineToLineDist2D)this._function).ResultInfo;
            }
            catch (Exception ee)
            {
