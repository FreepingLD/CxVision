...
{
    public partial class PointToPointDist2DForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public PointToPointDist2DForm(IFunction function,TreeNode node)
        {      
        ...
        private void PointToPointDist2DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.结果dataGridView.DataSource = ((PointToPointDist2D)this._function).ResultInfo;
        ...
        private void PointToPointDist2DForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
