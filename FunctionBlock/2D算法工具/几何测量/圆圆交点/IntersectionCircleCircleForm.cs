...
{
    public partial class IntersectionCircleCircleForm : Form
    {
        ...
        public IntersectionCircleCircleForm(IFunction function,TreeNode node)
        {
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.结果dataGridView.DataSource = ((FunctionBlock.IntersectionCircleCircle)this._function).ResultDataTable;   //resetShapeModel
            }
            catch (Exception ee)
            {
