...
{
    public partial class NPointToLineDist2DForm : Form
    {
        private IFunction _function;
        private VisualizeView drawObject;

        public NPointToLineDist2DForm(IFunction function,TreeNode node)
        {      
        ...
        private void NPointToLineDist2DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void NPointToLineDist2DForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
