...
{
    public partial class IntersectionLineCircleForm : Form
    {
        ...
        public IntersectionLineCircleForm(IFunction function,TreeNode node)
        {      
        ...
        private void IntersectionLineCircleForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.结果dataGridView.DataSource = ((FunctionBlock.IntersectionLineCirlce)this._function).ResultDataTable;
            }
            catch (Exception ee)
            {
