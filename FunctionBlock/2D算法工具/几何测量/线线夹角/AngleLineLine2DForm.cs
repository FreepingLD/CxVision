...
{
    public partial class AngleLineLine2DForm : Form
    {
        ...
        public AngleLineLine2DForm(IFunction function,TreeNode node)
        {
        ...
        private void AngleLineLine2DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.dataGridView1.DataSource = ((FunctionBlock.AngleLineLine2D)this._function).ResultDataTable;
                //this.标准值textBox.DataBindings.Add("Text", (FunctionBlock.AngleLineLine2D)this._function, "StdValue", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.上公差textBox.DataBindings.Add("Text", (FunctionBlock.AngleLineLine2D)this._function, "UpTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.下公差textBox.DataBindings.Add("Text", (FunctionBlock.AngleLineLine2D)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void AngleLineLine2DForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                // 注消事件
