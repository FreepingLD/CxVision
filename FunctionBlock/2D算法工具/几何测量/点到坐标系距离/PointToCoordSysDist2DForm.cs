...
{
    public partial class PointToCoordSysDist2DForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public PointToCoordSysDist2DForm(TreeNode node)
        {      
            InitializeComponent();
        ...
        private void PointToCoordSysDist2DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.结果dataGridView.DataSource = ((PointToCoordSysDist2D)this._function).ResultInfo;
