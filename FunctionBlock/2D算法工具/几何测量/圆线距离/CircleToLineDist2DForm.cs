...
{
    public partial class CircleToLineDist2DForm : Form
    {
        private IFunction _function;
        private VisualizeView drawObject;

        public CircleToLineDist2DForm(IFunction function,TreeNode node)
        {      
        ...
        private void CircleToLineDist2DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.结果dataGridView.DataSource = ((FunctionBlock.CircleToLineDist2D)this._function).ResultInfo;
            }
            catch (Exception ee)
            {
