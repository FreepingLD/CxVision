...
{
    partial class IntersectionLineContourForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IntersectionLineContourForm));
            ...
            this.Name = "IntersectionLineContourForm";
            this.ShowIcon = false;
            this.Tag = "1920,1080";
            this.Text = "直线轮廓交点";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.DeformableMatchForm_FormClosing);
            this.Load += new System.EventHandler(this.IntersectionLineContourForm_Load);
