...
{
    public partial class IntersectionLineLineForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public IntersectionLineLineForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.结果dataGridView.DataSource = ((FunctionBlock.IntersectionLineLine)this._function).ResultDataTable;
            }
            catch (Exception ee)
            {
