...
{
    public partial class NPointFitEllipseForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        //private RunToolStripWrapClass runToolStrip;
        public NPointFitEllipseForm( IFunction function,TreeNode node)
        {
            InitializeComponent();
        ...
        public void FitEllipseForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                EllipseFitParam param = ((NPointsFitEllipse)this._function).FitParam as EllipseFitParam;
                ...
                this.圆弧段数comboBox.DataBindings.Add(nameof(this.圆弧段数comboBox.Text), param, nameof(param.VossTabSize), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
