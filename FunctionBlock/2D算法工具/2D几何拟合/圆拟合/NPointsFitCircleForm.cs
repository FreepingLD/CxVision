...
{
    public partial class NPointsFitCircleForm : Form
    {
        protected Form form;
        protected IFunction _function;
        //private  HWindowControlViewWrapClass _view3D;
        //private RunToolStripWrapClass runToolStrip;
        private VisualizeView drawObject;
        public NPointsFitCircleForm( IFunction function,TreeNode node)
        {
            InitializeComponent();
        ...
        public void NPointsFitCircleForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        protected  void BindProperty()
        {
            try
            {
                ...
                CircleFitParam param = ((NPointsFitCircle)this._function).FitParam ;
