...
{
    public partial class NPointFitLineForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        //private RunToolStripWrapClass runToolStrip;
        public NPointFitLineForm( IFunction function,TreeNode node)
        {
            InitializeComponent();
        ...
        protected  void BindProperty()
        {
            try
            {
                ...
                LineFitParam param = ((NPointsFitLine)this._function).FitParam as LineFitParam;
