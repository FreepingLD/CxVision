...
{
    public partial class FindDeepOcrForm : Form
    {
        private FindNccModelParam _nccModelParam;
        public FindDeepOcrForm(FindNccModelParam Params)
        {
        ...
        private void 更多参数button_Click(object sender, EventArgs e)
        {
            try
            {
                new FindNccModelParamSubForm(this._nccModelParam).Show();
            }
            catch(Exception ex)
            {
