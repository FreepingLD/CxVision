...
namespace FunctionBlock
{
    ...
    public class ImageMorphology : BaseFunction, IFunction
    {
        [NonSerialized]
        private ImageDataClass _imageData;
        [NonSerialized]
        private ImageDataClass _outImageData;
        public DoImageMorphology MorphologyOperator { get; set; }
       // public ImageMorphologyParam MorphologyParam { get; set; }
        ...
        public ImageMorphology()
        {
            //this.MorphologyParam = new ImageRectParam();
            this.MorphologyOperator = new DoImageMorphology();
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                this.Result.Succss = this.MorphologyOperator.Do(this.ImageData?.Image, out hImge);
                this._outImageData = new ImageDataClass(hImge, this.ImageData.CamParams);
