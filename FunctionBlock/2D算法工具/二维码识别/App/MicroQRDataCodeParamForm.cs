...
{
    public partial class MicroQRDataCodeParamForm : Form
    {
        private DoDataCodeDetection _Detection;
        private MicroQRDataCodeParam _dataCodeParam;
        public MicroQRDataCodeParamForm(DataCodeParam Params)
        {
            this._dataCodeParam = Params as MicroQRDataCodeParam;
            InitializeComponent();
            BindProperty();
        }
        public MicroQRDataCodeParamForm(DoDataCodeDetection detection)
        {
            this._Detection = detection;
            this._dataCodeParam = detection.CodeParam as MicroQRDataCodeParam;
            InitializeComponent();
            BindProperty();
        }
