...
{
    public partial class ECC200DataCodeParamForm : Form
    {
        private DoDataCodeDetection _Detection;
        private ECC200DataCodeParam _dataCodeParam;
        public ECC200DataCodeParamForm(DataCodeParam Params)
        {
            this._dataCodeParam = Params as ECC200DataCodeParam;
            InitializeComponent();
            BindProperty();
        }
        public ECC200DataCodeParamForm(DoDataCodeDetection detection)
        {
            this._Detection = detection;
            this._dataCodeParam = detection.CodeParam as ECC200DataCodeParam;
            InitializeComponent();
            BindProperty();
        }
        private void BindProperty()
        {
            try
            {
                ...
                this.SlantMaxComboBox.DataBindings.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.slant_max), true, DataSourceUpdateMode.OnPropertyChanged);
                ...
                this.ContrastToleranceComboBox.DataBindings.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.contrast_tolerance), true, DataSourceUpdateMode.OnPropertyChanged);
                this.ModuleGridComboBox.DataBindings.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.module_grid), true, DataSourceUpdateMode.OnPropertyChanged);
                ...
                this.DecodingSchemeComboBox.DataBindings.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.decoding_scheme), true, DataSourceUpdateMode.OnPropertyChanged);
                ...
                this.SymbolShapeComboBox.DataBindings.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.symbol_shape), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void ECC200DataCodeParamForm_Load(object sender, EventArgs e)
        {
                ...
                if (this.默认参数comboBox.SelectedItem.ToString() != this._dataCodeParam.default_parameters)
                {
                    ...
                    if (dialogResult == DialogResult.OK)
                    {
                        ...
                        if (this._Detection.Reset_data_code_2d_param())
                        {
                            ...
                            this.SlantMaxComboBox.DataBindings.Clear();//.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.slant_max), true, DataSourceUpdateMode.OnPropertyChanged);
                            ...
                            this.ContrastToleranceComboBox.DataBindings.Clear();//.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.contrast_tolerance), true, DataSourceUpdateMode.OnPropertyChanged);
                            this.ModuleGridComboBox.DataBindings.Clear();//.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.module_grid), true, DataSourceUpdateMode.OnPropertyChanged);
                            ...
                            this.DecodingSchemeComboBox.DataBindings.Clear();//.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.decoding_scheme), true, DataSourceUpdateMode.OnPropertyChanged);
                            ...
                            this.SymbolShapeComboBox.DataBindings.Clear();//.Add("Text", this._dataCodeParam, nameof(this._dataCodeParam.symbol_shape), true, DataSourceUpdateMode.OnPropertyChanged);
                            this.BindProperty();
                        }
                        else
                        {
