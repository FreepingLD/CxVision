...
{
    public partial class AffineXLDContForm : Form
    {
        private object _objectDataModel;
        private IFunction _function;
        private VisualizeView drawObject;
        public AffineXLDContForm(IFunction function,TreeNode node)
        {
        ...
        private void AffineXLDContForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.AffineXLDCont2D.enShowItems));
                this.取反位姿comboBox.DataBindings.Add("Text", (FunctionBlock.AffineXLDCont2D)this._function, "InvertPose", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        {
            //AffineXLDCont2D.enShowItems content;
            //if (Enum.TryParse(this.显示条目comboBox.Text.Trim(), out content))
            //{
            //    switch (content)
            //    {
            //        case AffineXLDCont2D.enShowItems.输入对象:
            //            this.drawObject.XldContourData = new XldDataClass[] { (XldDataClass)this._function.GetPropertyValues("输入对象") };
            //            //this.DisplayObjectModel(this._function.GetPropertyValues("输入对象"));
            //            break;
            //        case AffineXLDCont2D.enShowItems.输出对象:
            //            this.drawObject.XldContourData = new XldDataClass[] { (XldDataClass)this._function.GetPropertyValues("输出对象") };
            //            //this.DisplayObjectModel(this._function.GetPropertyValues("输出对象"));
            //            break;
            //    }
            //}
            try
        ...
        private void AffineXLDContForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
