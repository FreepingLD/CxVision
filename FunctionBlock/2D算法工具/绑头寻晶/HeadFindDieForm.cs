...
{
    public partial class HeadFindDieForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        //private RunToolStripWrapClass runToolStrip;
        public HeadFindDieForm(TreeNode node)
        {
            InitializeComponent();
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.寻晶模式comboBox.DataSource = Enum.GetNames(typeof(enHeadFindDieMode));
                this.寻晶方向comboBox.DataSource = Enum.GetNames(typeof(enHeadFindDieOrientation));
                HeadFindDieParam param = ((HeadFindDie)this._function).Param;
                this.寻晶模式comboBox.DataBindings.Add(nameof(this.寻晶模式comboBox.Text), param, nameof(param.HeadFindDieMode), true, DataSourceUpdateMode.OnPropertyChanged);
                this.寻晶方向comboBox.DataBindings.Add(nameof(this.寻晶方向comboBox.Text), param, nameof(param.HeadFindDieOrientation), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ex)
            {
