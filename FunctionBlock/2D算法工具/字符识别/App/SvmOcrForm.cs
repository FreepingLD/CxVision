...
{
    public partial class SvmOcrForm : Form
    {
       private OcrSvmParam _param;
        public SvmOcrForm(OcrSvmParam param)
        {
            this._param = param;
            InitializeComponent();
            BindProperty();
        ...
        private void SvmOcrForm_Load(object sender, EventArgs e)
        {
