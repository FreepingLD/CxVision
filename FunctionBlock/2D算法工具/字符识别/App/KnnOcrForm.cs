...
{
    public partial class KnnOcrForm : Form
    {
       private OcrKnnParam _param;
        public KnnOcrForm(OcrKnnParam param)
        {
            this._param = param;
            InitializeComponent();
            BindProperty();
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.临近数量comboBox.DataBindings.Add("Text", this._param, "NumNeighbors", true, DataSourceUpdateMode.OnPropertyChanged);
        ...
        private void KnnOcrForm_Load(object sender, EventArgs e)
        {
