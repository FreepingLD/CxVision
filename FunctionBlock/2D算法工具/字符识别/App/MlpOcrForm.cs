...
{
    public partial class MlpOcrForm : Form
    {
       private OcrMlpParam _param;
        public MlpOcrForm(OcrMlpParam param)
        {
            this._param = param;
            InitializeComponent();
            BindProperty();
        ...
        private void MlpOcrForm_Load(object sender, EventArgs e)
        {
