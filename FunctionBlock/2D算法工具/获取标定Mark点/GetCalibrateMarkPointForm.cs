...
{
    public partial class GetCalibrateMarkPointForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public GetCalibrateMarkPointForm(IFunction function)
        {      
        ...
        private void GetCalibrateMarkPointForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
               // this.显示条目comboBox.DataSource = Enum.GetNames(typeof(LineMiddlePoint.enShowItems));
