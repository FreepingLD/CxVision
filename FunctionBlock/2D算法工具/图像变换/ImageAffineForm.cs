...
{
    public partial class ImageAffineForm : Form
    {
        private IFunction _function;
        private VisualizeView drawObject;
        private TreeNode _refnNode;
        public ImageAffineForm(IFunction function) 
        {
        ...
        public ImageAffineForm(IFunction function,TreeNode node)
        {
            this._refnNode = node;
            this._function = function;
            InitializeComponent();
            ...
            this.drawObject.BackImage = ((FunctionBlock.ImageAffine)this._function).ImageData;
        }
        private void AffineHImageForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            ...
            {  
                ...
                this.参考基准comboBox.DataBindings.Add("Text", ((FunctionBlock.ImageAffine)this._function).AffineParam, "InvertPose", true, DataSourceUpdateMode.OnPropertyChanged);
                this.插值方式comboBox.DataBindings.Add("Text", ((FunctionBlock.ImageAffine)this._function).AffineParam, "Interpolation", true, DataSourceUpdateMode.OnPropertyChanged);
                this.适配图像尺寸comboBox.DataBindings.Add("Text", ((FunctionBlock.ImageAffine)this._function).AffineParam, "AdaptImageSize", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void AffineHImageForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
