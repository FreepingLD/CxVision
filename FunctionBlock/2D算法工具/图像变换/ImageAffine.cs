...
namespace FunctionBlock
{
    ...
    public class ImageAffine : BaseFunction, IFunction
    {
        [NonSerialized]
        ...
        public ImageAffineParam AffineParam
        {
            get;
            set;
        }
        ...
        public ImageAffine()
        {
            this.AffineParam = new ImageAffineParam();
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                stopwatch.Restart();
                HImage hImage;
                this.Result.Succss = this.AffineParam.ImageAffine(this.ImageData.Image, this.PixCoordSystem, this.AffineParam, out hImage);
