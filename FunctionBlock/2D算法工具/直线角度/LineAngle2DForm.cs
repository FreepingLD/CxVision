...
{
    public partial class LineAngle2DForm : Form
    {
        private IFunction _function;
        private AutoReSizeFormControls arfc = new AutoReSizeFormControls();
        private VisualizeView drawObject;
        public LineAngle2DForm(IFunction function, TreeNode node)
        {
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.dataGridView1.DataSource = ((FunctionBlock.LineAngle2D)this._function).ResultInfo;
                this.角度类型comboBox.DataBindings.Add("Text", ((FunctionBlock.LineAngle2D)this._function), "Axis_Ref", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
