...
namespace FunctionBlock
{
    ...
    public class ImageEnhancement : BaseFunction, IFunction
    {
        [NonSerialized]
        private ImageDataClass _imageData;
        [NonSerialized]
        private ImageDataClass _outImageData;
        public DoImageEnhancement EnhancementOperator { get; set; }
        ...
        {
            this.EnhancementOperator = new DoImageEnhancement();
            //this.EnhancementParam = new ImageEnhancementParam();
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                this.Result.Succss = this.EnhancementOperator.Do(this.ImageData.Image,out hImge);
                ...
                OnExcuteCompleted(this._imageData.CamName,  this.name, this._outImageData);
            }
            catch (Exception ex)
            {
