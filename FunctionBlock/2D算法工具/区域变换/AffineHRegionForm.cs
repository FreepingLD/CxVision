...
{
    public partial class AffineHRegionForm : Form
    {
        private object _objectDataModel;
        private IFunction _function;
        private VisualizeView drawObject;
        public AffineHRegionForm(IFunction function)
        {
        ...
        private void AffineHRegionForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.AffineHRegion.enShowItems));
                this.取反位姿comboBox.DataBindings.Add("Text", (FunctionBlock.AffineHRegion)this._function, "InvertPose", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        {
            //AffineHRegion.enShowItems content;
            //if (Enum.TryParse(this.显示条目comboBox.Text.Trim(), out content))
            //{
            //    switch (content)
            //    {
            //        case AffineHRegion.enShowItems.输入对象:
            //            this.drawObject.AttachPropertyData.Clear();
            //            this.drawObject.AttachPropertyData.Add(this._function.GetPropertyValues("输入对象"));
            //            //this.DisplayObjectModel(this._function.GetPropertyValues("输入对象"));
            //            break;
            //        case AffineHRegion.enShowItems.输出对象:
            //            this.drawObject.AttachPropertyData.Clear();
            //            this.drawObject.AttachPropertyData.Add(this._function.GetPropertyValues("输出对象"));
        ...
        private void AffineHRegionForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
