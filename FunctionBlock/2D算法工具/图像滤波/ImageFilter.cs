...
namespace FunctionBlock
{
    ...
    public class ImageFilter : BaseFunction, IFunction
    {
        [NonSerialized]
        ...
        public ImageFilter()
        {
            this.FilterOperator = new DoImageFilter();
            //FilterParam = new MeanImageFilterParam();
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                OnExcuteCompleted(this.name, this._outImageData);
            }
            catch (Exception ex)
            {
