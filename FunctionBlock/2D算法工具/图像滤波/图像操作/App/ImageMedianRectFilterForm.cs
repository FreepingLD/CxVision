...
{
    public partial class ImageMedianRectFilterForm : Form
    {
        private ImageFilterParam _param;
        public ImageMedianRectFilterForm(ImageFilterParam param)
        {
            this._param = param;
            InitializeComponent();
            BindProperty();
        ...
        private void BindProperty()
        {
            ...
            {
                // 创建匹配参数
                MedianRectFilterParam filterParam = ((MedianRectFilterParam)this._param);
