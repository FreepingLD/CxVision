...
{
    public partial class VectorCompositionForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public VectorCompositionForm(IFunction function,TreeNode node)
        {      
        ...
        private void VectorCompositionForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void VectorCompositionForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
