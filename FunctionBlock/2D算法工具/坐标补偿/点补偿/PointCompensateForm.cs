...
{
    public partial class PointCompensateForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public PointCompensateForm(TreeNode node)
        {      
            InitializeComponent();
        ...
        private void PointCompensateForm_Load(object sender, EventArgs e)
        {
            // 注册事件
            ...
            BindProperty();
            this.AddForm(this.panel1, new CompensateListForm(((PointCompensate)this._function).Param, false));
        }
        ...
        private void BindProperty()
        {
            try
            {
               ...
               // this.结果dataGridView.DataSource = ((FunctionBlock.CalculateAngleBisector)this._function).ResultDataTable;
            }
            catch (Exception ex)
            {
        ...
        private void PointCompensateForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
