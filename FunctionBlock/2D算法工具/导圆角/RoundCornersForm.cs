...
{
    public partial class RoundCornersForm : Form
    {
        ...
        public RoundCornersForm(TreeNode node)
        {      
            InitializeComponent();
            this._refNode = node;
        ...
        private void RoundCornersForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(enShowItemRound));
                RoundCornerParam param = ((RoundCorners)this._function).Param;
                //this.圆弧极性comboBox.DataBindings.Add("Text", param, nameof(param.PointOrder), true, DataSourceUpdateMode.OnPropertyChanged);
                this.圆弧点数comboBox.DataBindings.Add("Text", param, nameof(param.InterPoint), true, DataSourceUpdateMode.OnPropertyChanged);
                this.导角圆半径comboBox.DataBindings.Add("Text", param, nameof(param.Radius), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ex)
            {
