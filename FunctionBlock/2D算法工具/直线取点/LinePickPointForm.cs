...
{
    public partial class LinePickPointForm : Form
    {
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        private TreeNode _refNode;
        public LinePickPointForm(TreeNode node)
        {
            InitializeComponent();
        ...
        private void LinePickPointForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.长度textBox.DataBindings.Add("Text", (LinePickPoint)this._function, "Length", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ex)
            {
        ...
        public void DisplayObjectModel(object sender, ExcuteCompletedEventArgs e)  // 这里一定要加一个键值对变量来收集，以免出现重合
        {
            ...
            {
                new Common.UserMessageForm(he.ToString()).ShowDialog();
                //new UserMessageForm().ShowDialog(he.ToString());
            }
        }
        ...
        private void LinePickPointForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
