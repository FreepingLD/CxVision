...
namespace FunctionBlock
{
    ...
    public class CrossPointMeasure : BaseFunction, IFunction
    {
        [NonSerialized]
        private ImageDataClass _imageData;
        private FindCrossPoint _findCrossPoint = new FindCrossPoint();
        ...
        public FindCrossPoint FindCrossPoint { get => _findCrossPoint; set => _findCrossPoint = value; }
        ...
        public CrossPointMeasure(string acqSourceName, IFunction coordSystem)
        {
        ...
        public CrossPointMeasure(IFunction imageSource, IFunction coordSystem)
        {
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                    ...
                    foreach (var item in param)
                    {
                        switch (item.GetType().Name)
                        {
                            case nameof(userWcsLine):
                                this._findCrossPoint.LineWcsPosition = (userWcsLine)item;
                                break;
                            case nameof(userPixLine):
                                this._findCrossPoint.LinePixPosition = (userPixLine)item;
                                break;
                            case nameof(userPixCoordSystem):
                ...
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[3].SetValue(this.name, "Cam_X", this._findCrossPoint.FitPoint.X - this._imageData.Grab_X);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[4].SetValue(this.name, "Cam_Y", this._findCrossPoint.FitPoint.Y - this._imageData.Grab_Y);
                ///////////////////////////////////////////////
                ...
                /////////
                LoggerHelper.Info(this.name + ":" + this._findCrossPoint.FitPoint.ToString());
                OnExcuteCompleted(this._imageData.CamName, this._imageData?.ViewWindow, this.name+ index, this._findCrossPoint.FitPoint);
            }
            catch (Exception ex)
            {
