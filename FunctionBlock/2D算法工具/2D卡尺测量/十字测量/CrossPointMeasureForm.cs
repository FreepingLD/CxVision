...
namespace FunctionBlock
{
    public partial class CrossPointMeasureForm : Form
    {
        ...
        public CrossPointMeasureForm(IFunction function,TreeNode node)
        {
            ...
            this.drawObject = new userDrawCrossMeasure(this.hWindowControl1, ((FunctionBlock.PointMeasure)_function).FindPoint.LinePixPosition, ((FunctionBlock.PointMeasure)_function).PixCoordSystem);
