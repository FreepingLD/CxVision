...
{
    public partial class ManualPointMeasureForm : Form
    {
        ...
        public ManualPointMeasureForm(IFunction function,TreeNode node)
        {
            this._function = function;
            this._refNode = node;
            InitializeComponent();
            this.Text = function.GetPropertyValues("名称").ToString();
            this.drawObject = new userDrawManualPointMeasure(this.hWindowControl1, ((FunctionBlock.ManualPointMeasure)_function).FindCrossPoint.PointPixPosition.AffineTransPixPoint(((FunctionBlock.ManualPointMeasure)_function).PixCoordSystem?.GetVariationHomMat2D()), ((FunctionBlock.ManualPointMeasure)_function).PixCoordSystem);
        ...
        private void CrossPointMeasureForm_Load(object sender, EventArgs e)
        {
            ...
            //////////////////////////////////////
            this.drawObject.BackImage = ((FunctionBlock.ManualPointMeasure)_function).ImageData;
            BindProperty();
        }
        private void BindProperty()
        {
            try
            {
                ...
                this.相机采集源comboBox.DataBindings.Add(nameof(this.相机采集源comboBox.SelectedItem), ((FunctionBlock.ManualPointMeasure)this._function), "AcqSourceName", true, DataSourceUpdateMode.OnPropertyChanged);
                /////////////////////////
        ...
        public void 示教点位button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.drawObject?.SetParam(((ManualPointMeasure)this._refNode.Tag).PixCoordSystem);
                this.drawObject?.SetParam(((ManualPointMeasure)this._refNode.Tag).FindCrossPoint.PointPixPosition.AffineTransPixPoint(((ManualPointMeasure)this._refNode.Tag).PixCoordSystem?.GetVariationHomMat2D()));
                this.drawObject.BackImage = ((ManualPointMeasure)this._refNode.Tag).ImageData != null ? ((ManualPointMeasure)this._refNode.Tag).ImageData : null;
