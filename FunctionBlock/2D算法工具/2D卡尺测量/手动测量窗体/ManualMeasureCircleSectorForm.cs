...
{
    public partial class ManualMeasureCircleSectorForm : Form
    {
        private IFunction _function;
        private userDrawCircleROI drawObject;
        private drawPixCircleSector _pixCircleSector;

        public drawPixCircleSector PixCircleSector { get => _pixCircleSector; set => _pixCircleSector = value; }


        public ManualMeasureCircleSectorForm(ImageDataClass imageData, drawPixCircle pixCircle)
        {
            InitializeComponent();
        ...
        private void 确定button_Click(object sender, EventArgs e)
        {
            try
            {
                this._pixCircleSector = new drawPixCircleSector();// this.drawObject.GetDrawPixCircleSectorParam();
