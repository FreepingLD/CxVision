...
{
    public partial class ManualMeasureEllipseForm : Form
    {
        ...
        public ManualMeasureEllipseForm(ImageDataClass imageData, drawPixEllipse pixEllipse)
        {
            ...
            if (imageData.IsInitialized())
            {
                ...
                this.drawObject?.SetParam(pixEllipse);
                this.drawObject.DrawingGraphicObject();
            }

        }
        private void ManualMeasureEllipseForm_Load(object sender, EventArgs e)
        {
        ...
        private void ManualMeasureEllipseForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
