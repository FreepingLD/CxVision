...
namespace FunctionBlock
{
    public partial class CircleSectorMeasureForm : Form
    {
        ...
        public CircleSectorMeasureForm(IFunction function, TreeNode node)
        {
            ...
            this.drawObject = new userDrawCircleSectorMeasure(this.hWindowControl1, ((CircleSectorMeasure)_function).FindCircleSector.CircleSectorPixPosition, ((CircleSectorMeasure)_function).PixCoordSystem);
            ...
            try
            {
                switch (e.ClickedItem.Text)
                {
                    case "执行":
                        ...
                        Task.Run(() =>
                        {
                            if (this._function.Execute(this.drawObject.GetPixCircleSectorParam()).Succss)
                            {
