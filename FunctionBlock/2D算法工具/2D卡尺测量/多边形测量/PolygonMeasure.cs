...
namespace FunctionBlock
{
    ...
    public class PolygonMeasure : BaseFunction, IFunction
    {
        [NonSerialized]
        private ImageDataClass _imageData;
        private string _AcqSourceName;
        private FindPolygon _findPolygon = new FindPolygon();
        ...
        public FindPolygon FindPolygon { get => _findPolygon; set => _findPolygon = value; }


        [DisplayName("多边形")]
        [DescriptionAttribute("输出属性")]
        public userWcsPolygon WcsPolygon { get; set; }
        ...
        public PolygonMeasure()
        {
            InitBindingTable();
        }
        public PolygonMeasure(string acqSourceName, IFunction coordSystem)
        {
        ...
        public PolygonMeasure(IFunction imageSource, IFunction coordSystem)
        {
            ////////////////////////////////
            InitBindingTable();
        }
        private void InitBindingTable()
        {
            if (this.ResultInfo == null)
            {
                ...
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "X1", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "轨迹_X", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "轨迹_Y", "0"));
                //////////////拍照坐标
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Grab_X", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Grab_Y", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Grab_Z", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Grab_Theat", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Grab_U", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Grab_V", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Angle", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "执行结果", "0"));
                ((BindingList<OcrResultInfo>)this.ResultInfo).Add(new OcrResultInfo(this.name, "Time", "0"));
            }
        }
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                    ...
                    foreach (var item in param)
                    {
                        ...
                        switch (item.GetType().Name)
                        {
                            case nameof(userWcsPolygon):
                                this._findPolygon.PolygonWcsPosition = (userWcsPolygon)item;
                                break;
                            ...
                            case nameof(userPixCoordSystem):
                                ...
                                break;
                            case nameof(String):
                                if (item.ToString().Split('=').Length > 0 && item.ToString() != "manual")
                ...
                this.WcsPolygon = this._findPolygon.FitPolygon;     
                ///////////////////////////////////////////
                this.CreateResultInfo(11);
                stopwatch.Stop();
                ((BindingList<OcrResultInfo>)this.ResultInfo)[0].SetValue(this.name, "Count", $"{this._findPolygon.FitPolygon.X.Count}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[1].SetValue(this.name, "轨迹_X", $"{ string.Join(",", this._findPolygon.FitPolygon.X)}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[2].SetValue(this.name, "轨迹_Y", $"{ string.Join(",", this._findPolygon.FitPolygon.Y)}");
                /////////////////////////////////////////
                ((BindingList<OcrResultInfo>)this.ResultInfo)[3].SetValue(this.name, "Grab_X", $"{this._imageData.Grab_X}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[4].SetValue(this.name, "Grab_Y", $"{this._imageData.Grab_Y}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[5].SetValue(this.name, "Grab_Z", $"{this._imageData.Grab_Z}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[6].SetValue(this.name, "Grab_Theat", $"{this._imageData.Grab_Theta}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[7].SetValue(this.name, "Grab_U", $"{this._imageData.Grab_U}");
                ((BindingList<OcrResultInfo>)this.ResultInfo)[8].SetValue(this.name, "Grab_V", $"{this._imageData.Grab_V}");
                ...
                /////////
                LoggerHelper.Debug(this.name + ":" + this._findPolygon.FitPolygon.ToString());
                ...
                OnExcuteCompleted(this.WcsPolygon?.CamName, this.WcsPolygon?.ViewWindow, this.name , this.WcsPolygon);
            }
            catch (Exception ex)
            {
                this.Result.Succss = false;
                LoggerHelper.Error(this.name + "->执行报错" + ex, this.WcsPolygon?.CamName);
            }
            finally
            {
            ...
            if (this.Result.Succss)
                LoggerHelper.Info(this.name + "->执行成功", this.WcsPolygon?.CamName);
            else
                LoggerHelper.Error(this.name + "->执行失败", this.WcsPolygon?.CamName);
        ...
        public object GetPropertyValues(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case nameof(WcsPolygon):
                default:
                    return this.WcsPolygon;
            }
        }
