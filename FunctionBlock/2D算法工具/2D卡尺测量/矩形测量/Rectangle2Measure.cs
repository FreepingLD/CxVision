...
namespace FunctionBlock
{
    ...
    public class Rectangle2Measure : BaseFunction, IFunction
    {
        [NonSerialized]
        ...
        private FindRectangle2 _findRect2 = new FindRectangle2();
        ...
        [DisplayName("相机矩形对象")]
        [DescriptionAttribute("输出属性")]
        public userWcsRectangle2 CamWcsRect2 { get; set; }
        ...
        public FindRectangle2 FindRect2 { get => _findRect2; set => _findRect2 = value; }


        public Rectangle2Measure()
        {
            /////////
            InitBindingTable();
        }
        public Rectangle2Measure(string acqSourceName, IFunction coordSystem)
        {
        ...
        public Rectangle2Measure(IFunction imageSource, IFunction coordSystem)
        {
            InitBindingTable();
        }
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                    ...
                    foreach (var item in param)
                    {
                        switch (item.GetType().Name)
                        {
                            case nameof(userWcsRectangle2):
                                this._findRect2.Rect2WcsPosition = (userWcsRectangle2)item;
                                break;
                            case nameof(userPixRectangle2):
                                this._findRect2.Rect2PixPosition = (userPixRectangle2)item;
                                break;
                            case nameof(userPixCoordSystem):
                ...
                if (this._pixCoordSystem == null)
                    this.Result.Succss = this._findRect2.FindRect2Method(this.ImageData, this.PixCoordSystem, offsetCoordSys);
                else
                    this.Result.Succss = this._findRect2.FindRect2Method(this.ImageData, this._pixCoordSystem, offsetCoordSys);
                this.WcsRect2 = this._findRect2.FitRect2;
                this.WcsRect2.CamName = this._imageData.CamName;
                this.WcsRect2.ViewWindow = this._imageData.ViewWindow;
                stopwatch.Stop();
                ///////////////////////////////
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[0].SetValue(this.name, "X", this._findRect2.FitRect2.X);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[1].SetValue(this.name, "Y", this._findRect2.FitRect2.Y);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[2].SetValue(this.name, "Z", this._findRect2.FitRect2.Z);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[3].SetValue(this.name, "角度", this._findRect2.FitRect2.Deg);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[4].SetValue(this.name, "长度1", this._findRect2.FitRect2.Length1);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[5].SetValue(this.name, "长度2", this._findRect2.FitRect2.Length2);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[6].SetValue(this.name, "Cam_X", this._findRect2.FitRect2.X - this._imageData.Grab_X);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[7].SetValue(this.name, "Cam_Y", this._findRect2.FitRect2.Y - this._imageData.Grab_Y);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[8].SetValue(this.name, "Cam_Deg", this._findRect2.FitRect2.Deg);
                ////////////////////////////////
                ...
                //((BindingList<MeasureResultInfo>)this.ResultInfo)[15].SetValue(this.name, "Time", stopwatch.ElapsedMilliseconds);
                //////////////////////////////
                LoggerHelper.Info(this.name + ":" + this._findRect2.FitRect2.ToString());
                OnExcuteCompleted(this.WcsRect2?.CamName, this.WcsRect2?.ViewWindow, this.name + index, this._findRect2.FitRect2);
            }
            catch (Exception ex)
            {
        ...
        public object GetPropertyValues(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case nameof(this.CamWcsRect2):
                    return this.CamWcsRect2;
                default:
