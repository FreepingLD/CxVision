...
namespace FunctionBlock
{
    public partial class CircleMeasureForm : Form
    {
        ...
        public CircleMeasureForm(IFunction function, TreeNode node)
        {
            ...
            this.drawObject = new userDrawCircleMeasure(this.hWindowControl1, ((CircleMeasure)_function).FindCircle.CirclePixPosition, ((CircleMeasure)_function).PixCoordSystem);
            ...
            try
            {
                switch (e.ClickedItem.Text)
                {
                    case "执行":
                        ...
                        Task.Run(() =>
                        {
                            if (this._function.Execute(this.drawObject.GetPixCircleParam()).Succss)
                            {
