...
{
    public partial class ManualCircleMeasureForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private userDrawManualCircleMeasure drawObject;
        private TreeNode _refNode;
        private MetrolegyParamForm metrolegyParam;
        public ManualCircleMeasureForm(IFunction function,TreeNode node)
        {
        ...
        private void ManualCircleMeasureForm_Load(object sender, EventArgs e)
        {
            ...
            //////////////////////////////////////
            this.drawObject.BackImage = ((FunctionBlock.ManualCircleMeasure)_function).ImageData;
            BindProperty();
        }
        private void BindProperty()
        {
            try
            {
                ...
                this.相机采集源comboBox.DataBindings.Add(nameof(this.相机采集源comboBox.SelectedItem), ((FunctionBlock.ManualCircleMeasure)this._function), "AcqSourceName", true, DataSourceUpdateMode.OnPropertyChanged);
                /////////////////////////
                        ...
                        Task.Run(() =>
                        {
                            if (this._function.Execute(this.drawObject.GetPixCircleParam(), this._refNode).Succss)
                            {
                                this.Invoke(new Action(() =>
                                {
                                    ...
                                    this.drawObject.DetachDrawingObjectFromWindow();
                                    this.drawObject.AddViewObject(new ViewData(((FunctionBlock.ManualCircleMeasure)this._function).WcsCircle.GetPixCircle().GetXLD()));
                                }));
                            }
                            else
                            {
        ...
        public void 示教点位button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.drawObject?.SetParam(((ManualCircleMeasure)this._refNode.Tag).PixCoordSystem);
                this.drawObject?.SetParam(((ManualCircleMeasure)this._refNode.Tag).FindCrossPoint.CirclePixPosition.AffineTransPixCircle(((ManualCircleMeasure)this._refNode.Tag).PixCoordSystem?.GetVariationHomMat2D()));
                this.drawObject.BackImage = ((ManualCircleMeasure)this._refNode.Tag).ImageData != null ? ((ManualCircleMeasure)this._refNode.Tag).ImageData : null;
