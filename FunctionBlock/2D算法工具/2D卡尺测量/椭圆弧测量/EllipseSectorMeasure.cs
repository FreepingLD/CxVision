...
namespace FunctionBlock
{
    ...
    public class EllipseSectorMeasure : BaseFunction, IFunction
    {
        [NonSerialized]
        ...
        private FindEllipseSector _findEllipseSector = new FindEllipseSector();
        ...
        public userWcsEllipseSector WcsEllipseSector { get; set; }
        [DisplayName("采集源")]
        ...
        public FindEllipseSector FindEllipseSector { get => _findEllipseSector; set => _findEllipseSector = value; }



        public EllipseSectorMeasure(string acqSourceName, IFunction coordSystem)
        {
        ...
        public EllipseSectorMeasure(IFunction imageSource, IFunction coordSystem)
        {
            /////////////////////////////////////////////////////////
            InitBindingTable();
        }

        public EllipseSectorMeasure()
        {
            /////////////////////////////////////////////////////////
            InitBindingTable();
        }
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                    ...
                    foreach (var item in param)
                    {
                        switch (item.GetType().Name)
                        {
                            case nameof(userWcsEllipseSector):
                                this._findEllipseSector.EllipseSectorWcsPosition = (userWcsEllipseSector)item;
                                break;
                            case nameof(userPixEllipseSector):
                                this._findEllipseSector.EllipseSectorPixPosition = (userPixEllipseSector)item;
                                break;
                            case nameof(userPixCoordSystem):
                ...
                if (this._pixCoordSystem == null)
                    this.Result.Succss = this._findEllipseSector.FindEllipseSectorMethod(this.ImageData, this.PixCoordSystem, offsetCoordSys);
                else
                    this.Result.Succss = this._findEllipseSector.FindEllipseSectorMethod(this.ImageData, this._pixCoordSystem, offsetCoordSys);
                this.WcsEllipseSector = this._findEllipseSector.FitEllipseSector;
                this.WcsEllipseSector.CamName = this._imageData.CamName;
                this.WcsEllipseSector.ViewWindow = this._imageData.ViewWindow;
                stopwatch.Stop();
                /////////////////////////////
                this.InitBindingTable();
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[0].SetValue(this.name, "X", this._findEllipseSector.FitEllipseSector.X);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[1].SetValue(this.name, "Y", this._findEllipseSector.FitEllipseSector.Y);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[2].SetValue(this.name, "Z", this._findEllipseSector.FitEllipseSector.Z);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[3].SetValue(this.name, "半径R1", this._findEllipseSector.FitEllipseSector.Radius1);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[4].SetValue(this.name, "半径R2", this._findEllipseSector.FitEllipseSector.Radius2);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[5].SetValue(this.name, "长轴", this._findEllipseSector.FitEllipseSector.Radius1 * 2);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[6].SetValue(this.name, "短轴", this._findEllipseSector.FitEllipseSector.Radius2 * 2);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[7].SetValue(this.name, "角度", this._findEllipseSector.FitEllipseSector.Deg);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[8].SetValue(this.name, "起始角", this._findEllipseSector.FitEllipseSector.Start_deg);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[9].SetValue(this.name, "终止角", this._findEllipseSector.FitEllipseSector.End_deg);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[10].SetValue(this.name, "Cam_X", this._findEllipseSector.FitEllipseSector.X - this._imageData.Grab_X);
                ((BindingList<MeasureResultInfo>)this.ResultInfo)[11].SetValue(this.name, "Cam_Y", this._findEllipseSector.FitEllipseSector.Y - this._imageData.Grab_Y);
                ...
                //////////////////////////////////////
                LoggerHelper.Info(this.name + ":" + this._findEllipseSector.FitEllipseSector.ToString());
                OnExcuteCompleted(this.WcsEllipseSector?.CamName, this.WcsEllipseSector?.ViewWindow, this.name + index, this.WcsEllipseSector);
            }
            catch (Exception ex)
            {
        ...
        public object GetPropertyValues(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case nameof(WcsEllipseSector):
                default:
                    return this.WcsEllipseSector;
            }
        }
