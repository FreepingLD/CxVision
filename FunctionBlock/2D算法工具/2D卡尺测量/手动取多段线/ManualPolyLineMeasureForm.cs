...
{
    public partial class ManualPolyLineMeasureForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private userDrawManualPolyLineMeasure drawObject;
        private TreeNode _refNode;
        private MetrolegyParamForm metrolegyParam;
        public ManualPolyLineMeasureForm(IFunction function,TreeNode node)
        {
        ...
        private void ManualPolyLineMeasureForm_Load(object sender, EventArgs e)
        {
            ...
            //////////////////////////////////////
            this.drawObject.BackImage = ((FunctionBlock.ManualPolyLineMeasure)_function).ImageData;
            BindProperty();
        }
        private void BindProperty()
        {
            try
            {
                ...
                this.相机采集源comboBox.DataBindings.Add(nameof(this.相机采集源comboBox.SelectedItem), ((FunctionBlock.ManualPolyLineMeasure)this._function), "AcqSourceName", true, DataSourceUpdateMode.OnPropertyChanged);
                /////////////////////////
                        ...
                        Task.Run(() =>
                        {
                            if (this._function.Execute(this.drawObject.GetPixPolyLineParam(), this._refNode).Succss)
                            {
                                this.Invoke(new Action(() =>
                                {
                                    ...
                                    this.drawObject.DetachDrawingObjectFromWindow();
                                    this.drawObject.AddViewObject(new ViewData(((FunctionBlock.ManualPolyLineMeasure)this._function).WcsPolyLine.GetPixPolyLine().GetXLD()));
                                }));
                            }
                            else
                            {
        ...
        public void 示教点位button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.drawObject?.SetParam(((ManualPolyLineMeasure)this._refNode.Tag).PixCoordSystem);
                this.drawObject?.SetParam(((ManualPolyLineMeasure)this._refNode.Tag).FindPolyLine.PolyLinePixPosition.AffinePixPolyLine(((ManualPolyLineMeasure)this._refNode.Tag).PixCoordSystem?.GetVariationHomMat2D()));
                this.drawObject.BackImage = ((ManualPolyLineMeasure)this._refNode.Tag).ImageData != null ? ((ManualPolyLineMeasure)this._refNode.Tag).ImageData : null;
