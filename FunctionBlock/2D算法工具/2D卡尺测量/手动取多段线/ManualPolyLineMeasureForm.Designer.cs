...
{
    partial class ManualPolyLineMeasureForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ManualPolyLineMeasureForm));
            ...
            this.Name = "ManualPolyLineMeasureForm";
            this.ShowIcon = false;
            this.Tag = "1920,1080";
            this.Text = "手动取点";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FindLineForm_FormClosing);
            this.Load += new System.EventHandler(this.ManualPolyLineMeasureForm_Load);
