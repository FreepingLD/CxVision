...
{
    public partial class ManualCircleSectorMeasureForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private userDrawManualCircleSectorMeasure drawObject;
        private TreeNode _refNode;
        private MetrolegyParamForm metrolegyParam;

        public ManualCircleSectorMeasureForm(IFunction function, TreeNode node)
        {
        ...
        private void ManualCircleSectorMeasureForm_Load(object sender, EventArgs e)
        {
            ...
            //////////////////////////////////////
            this.drawObject.BackImage = ((FunctionBlock.ManualCircleSectorMeasure)_function).ImageData;
            BindProperty();
        }
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.相机采集源comboBox.DataBindings.Add(nameof(this.相机采集源comboBox.SelectedItem), ((FunctionBlock.ManualCircleSectorMeasure)this._function), "AcqSourceName", true, DataSourceUpdateMode.OnPropertyChanged);
                /////////////////////////
                        ...
                        Task.Run(() =>
                        {
                            if (this._function.Execute(this.drawObject.GetPixCircleSectorParam(), this._refNode).Succss)
                            {
                                this.Invoke(new Action(() =>
                                {
                                    ...
                                    this.drawObject.DetachDrawingObjectFromWindow();
                                    this.drawObject.AddViewObject(new ViewData(((FunctionBlock.ManualCircleSectorMeasure)this._function).WcsCircleSector.GetPixCircleSector().GetXLD()));
                                }));
                            }
                            else
                            {
        ...
        public void 示教点位button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.drawObject?.SetParam(((ManualCircleSectorMeasure)this._refNode.Tag).PixCoordSystem);
                this.drawObject?.SetParam(((ManualCircleSectorMeasure)this._refNode.Tag).FindCircleSector.CircleSectorPixPosition.AffineTransPixCircleSector(((ManualCircleSectorMeasure)this._refNode.Tag).PixCoordSystem?.GetVariationHomMat2D()));
                this.drawObject.BackImage = ((ManualCircleSectorMeasure)this._refNode.Tag).ImageData != null ? ((ManualCircleSectorMeasure)this._refNode.Tag).ImageData : null;
