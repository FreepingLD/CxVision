...
{
    partial class ManualCircleSectorMeasureForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ManualCircleSectorMeasureForm));
            ...
            this.Name = "ManualCircleSectorMeasureForm";
            this.ShowIcon = false;
            this.Tag = "1920,1080";
            this.Text = "手动取圆弧";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FindLineForm_FormClosing);
            this.Load += new System.EventHandler(this.ManualCircleSectorMeasureForm_Load);
