    ...
    public partial class CameraGlueGunCalibrateForm : Form
    {
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.胶枪编号comboBox.SelectedItem = enRobotJawEnum.胶枪1;
                ////////////////////////////////////////////////////////
        ...
        private void 相机取点button_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.drawObject.BackImage != null)
                {
                    ...
                    enCoordSysName coordSysName = AcqSourceManage.Instance.GetAcqSource(this.相机采集源comboBox.Text).CoordSysName;
                    CoordSysAxisPosParam axisParam = new CoordSysAxisPosParam(coordSysName);
        ...
        private void 标定button_Click(object sender, EventArgs e)
        {
            ...
            {
                new Common.UserMessageForm("标定报错" + ex.ToString()).ShowDialog();
            }
        }
