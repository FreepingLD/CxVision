...
{
    public partial class CameraLineLaserCalibrateForm : Form
    {
        ...
        private void 激光直线测量1button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    new UserMessageForm().ShowDialog("图像数据为空");
                    return;
                }
        ...
        private void 激光扫描button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CommandParam1.AxisParam =new  CoordSysAxisPosParam( x1, y1, z1,0,0,0 );
                ////////////
                ...
                CommandParam2.AxisParam = new CoordSysAxisPosParam (x2, y2, z2,0,0,0) ;
                ...
                pointData1.TransformDataAndCalibrateData(list, _laserAcqSource.Sensor.ConfigParam.SensorType, _laserAcqSource.Sensor.LaserParam.DataWidth, _laserAcqSource.Sensor.LaserParam.ScanAxis, CommandParam1.AxisParam, CommandParam2.AxisParam, refCalibrateDataValue);
            ...
            {
                new UserMessageForm().ShowDialog("激光扫描button_Click操作失败" + new Exception().ToString());
            }
        }
        ...
        private void 保存button_Click(object sender, EventArgs e)
        {
            try
            {
                string path = Application.StartupPath + "\\" + "激光标定参数" + "\\" + this._laserAcqSource.Sensor.Name + this._cameraAcqSource.Sensor.Name + ".xml";
        ...
        private void 标定button_Click(object sender, EventArgs e)
        {
            ...
            {
                new UserMessageForm().ShowDialog("标定button_Click操作失败");
            }
        }
        ...
        private void 获取当前激光位置2button_Click(object sender, EventArgs e)
        {
            double x, y, z;
            try
            {
