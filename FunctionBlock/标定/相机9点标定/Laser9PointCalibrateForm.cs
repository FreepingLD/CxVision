...
{
    public partial class Laser9PointCalibrateForm : Form
    {
        ...
        public Laser9PointCalibrateForm(LaserParam laserParam)
        {
            InitializeComponent();
            ...
            this.calibCoordConfigParamRota.Read(programPath + "\\" + this._laserParam.SensorName + "\\" + "RotaCalibConfigParam.xml");
            this.calibCoordConfigParamRotaV.Read(programPath + "\\" + this._laserParam.SensorName + "\\" + "RotaCalibConfigParamVAxis.xml");
            this.calibCoordConfigParamRotaU.Read(programPath + "\\" + this._laserParam.SensorName + "\\" + "RotaCalibConfigParamUAxis.xml");
            this.calibCoordConfigParamNPoint.Read(programPath + "\\" + this._laserParam.SensorName + "\\" + "NPointCalibConfigParam.xml");
        ...
        private void Laser9PointCalibrateForm_Load(object sender, EventArgs e)
        {
            // 注册事件
            ...
            this._treeViewWrapClassNPoint.OpenProgram(this.programPath + "\\" + this._laserParam.SensorName);
            this.isLoad = true;
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.标定轴comboBox.DataBindings.Add(nameof(this.标定轴comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.CalibAxis), true, DataSourceUpdateMode.OnPropertyChanged);
                ...
                this.坐标值类型comboBox.DataBindings.Add(nameof(this.坐标值类型comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.CoordValueType), true, DataSourceUpdateMode.OnPropertyChanged);
                this.标定方法comboBox.DataBindings.Add(nameof(this.标定方法comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.CalculateMethod), true, DataSourceUpdateMode.OnPropertyChanged);
                this.角度范围numericUpDown.DataBindings.Add(nameof(this.角度范围numericUpDown.Value), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.AngleRange), true, DataSourceUpdateMode.OnPropertyChanged);
                this.旋转步数numericUpDown.DataBindings.Add(nameof(this.旋转步数numericUpDown.Value), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.AngleStep), true, DataSourceUpdateMode.OnPropertyChanged);
                this.旋转方向comboBox.DataBindings.Add(nameof(this.旋转方向comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.RotateDirection), true, DataSourceUpdateMode.OnPropertyChanged);
                this.运控平台comboBox.DataBindings.Add(nameof(this.运控平台comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.MoveStage), true, DataSourceUpdateMode.OnPropertyChanged);
                this.V轴角度范围numericUpDown.DataBindings.Add(nameof(this.V轴角度范围numericUpDown.Value), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.AngleRangeAxisV), true, DataSourceUpdateMode.OnPropertyChanged);
                this.V轴旋转步数numericUpDown.DataBindings.Add(nameof(this.V轴旋转步数numericUpDown.Value), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.AngleStepAxisV), true, DataSourceUpdateMode.OnPropertyChanged);
                this.V轴旋转方向comboBox.DataBindings.Add(nameof(this.V轴旋转方向comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.RotateDirectionAxisV), true, DataSourceUpdateMode.OnPropertyChanged);
                this.U轴角度范围numericUpDown.DataBindings.Add(nameof(this.U轴角度范围numericUpDown.Value), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.AngleRangeAxisU), true, DataSourceUpdateMode.OnPropertyChanged);
                this.U轴旋转步数numericUpDown.DataBindings.Add(nameof(this.U轴旋转步数numericUpDown.Value), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.AngleStepAxisU), true, DataSourceUpdateMode.OnPropertyChanged);
                this.U轴旋转方向comboBox.DataBindings.Add(nameof(this.U轴旋转方向comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.RotateDirectionAxisU), true, DataSourceUpdateMode.OnPropertyChanged);
                this.标定平面comboBox.DataBindings.Add(nameof(this.标定平面comboBox.Text), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.CalibPlane), true, DataSourceUpdateMode.OnPropertyChanged);
                this.取反X轴checkBox.DataBindings.Add(nameof(this.取反X轴checkBox.Checked), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.InvertX), true, DataSourceUpdateMode.OnPropertyChanged);
                this.取反Y轴checkBox.DataBindings.Add(nameof(this.取反Y轴checkBox.Checked), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.InvertY), true, DataSourceUpdateMode.OnPropertyChanged);
                this.取反Z轴checkBox.DataBindings.Add(nameof(this.取反Z轴checkBox.Checked), this._laserParam.CaliParam, nameof(this._laserParam.CaliParam.InvertZ), true, DataSourceUpdateMode.OnPropertyChanged);
                ////////// 通信配置/////////////////
                if (this._laserParam.CaliParam.RotateCalibPoint == null)
                    this._laserParam.CaliParam.RotateCalibPoint = new userWcsVector();
                this.旋转中心位置坐标textBox.Text = "X:" + this._laserParam.CaliParam.RotateCalibPoint.X.ToString("f3") + "   Y:" +
                this._laserParam.CaliParam.RotateCalibPoint.Y.ToString("f3") + "   Z:" + this._laserParam.CaliParam.RotateCalibPoint.Z.ToString("f3") + "   Theta:" + this._laserParam.CaliParam.RotateCalibPoint.Angle.ToString("f3")
                + "   U:" + this._laserParam.CaliParam.RotateCalibPoint.Angle_x.ToString("f4") + "   V:" + this._laserParam.CaliParam.RotateCalibPoint.Angle_y.ToString("f4");
                /////////////////////////////////////////////////////////////////
                if (this._laserParam.CaliParam.StartCaliPoint == null)
                    this._laserParam.CaliParam.StartCaliPoint = new userWcsVector();
                //userWcsVector wcsVector = this.CamParam.NPointCalibParam.StartCaliPoint;
                this.起始点textBox.Text = "X:" + this._laserParam.CaliParam.StartCaliPoint.X.ToString("f3") +
                    "   Y:" + this._laserParam.CaliParam.StartCaliPoint.Y.ToString("f3") +
                    "   Z:" + this._laserParam.CaliParam.StartCaliPoint.Z.ToString("f4") +
                    "   Theta:" + this._laserParam.CaliParam.StartCaliPoint.Angle.ToString("f4");
                ////////////////////////////////////////////////////////////////////////
                if (this._laserParam.CaliParam.EndCalibPoint == null)
                    this._laserParam.CaliParam.EndCalibPoint = new userWcsVector();
                this.终止点textBox.Text = "X:" + this._laserParam.CaliParam.EndCalibPoint.X.ToString("f3") +
                                          "   Y:" + this._laserParam.CaliParam.EndCalibPoint.Y.ToString("f3") +
                                          "   Z:" + this._laserParam.CaliParam.EndCalibPoint.Z.ToString("f4") +
                                          "   Theta:" + this._laserParam.CaliParam.EndCalibPoint.Angle.ToString("f4");
                ////////////////////////////////////////////////////////////////////////
                this.相机轴坐标textBox.Text = "X:" + this._laserParam.CaliParam.CamAxisCoord.X.ToString("f3") +
                     "   Y:" + this._laserParam.CaliParam.CamAxisCoord.Y.ToString("f3") + "   Z:" + this._laserParam.CaliParam.CamAxisCoord.Z.ToString("f3");
        ...
        private void 获取旋转中心button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                /////////////////////////////////////////////
                this._laserParam.CaliParam.RotateCalibPoint = new userWcsVector(X, Y, Z, U, V, Theta);
        ...
        private void 获取起始点button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Read(out X, out Y, out Z, out Theta, out U, out V);
                ///////////////////////
                this._laserParam.CaliParam.StartCaliPoint = new userWcsVector(X, Y, Z, Theta);
        ...
        private void 获取终止点button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Read(out X, out Y, out Z, out Theta, out U, out V);
                ///////////////////////
                this._laserParam.CaliParam.EndCalibPoint = new userWcsVector(X, Y, Z, Theta);
        ...
        {
            IMotionControl card = MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName);
            if (card == null)
            {
                X = 0;
                Y = 0;
            ...
            {
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.X轴, out X);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.Y轴, out Y);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.Z轴, out Z);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.Theta轴, out Theta);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.U轴, out U);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.V轴, out V);
            }
        }
        private void Write(double X, double Y, double Z, double Theta)
        {
            IMotionControl card = MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName);
            if (card != null)
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).MoveMultyAxis(this._laserParam.CaliParam.CoordSysName, enAxisName.XYZTheta轴, 0, new CoordSysAxisParam(X, Y, Z, Theta, 0, 0));
        }
        ...
        private void CalibPlc()
        {
            ...
            string info="";
            double X, Y, Z, Theta;
            double center_Row=0, center_Col=0, error=0,rotaeAngle=0;
            ...
            //// 初始化触发信号并等待触发信号 
            CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerFromPlc,0);
            while (true)
            {
                if (this.isStop) return; // 控制标定停止
                Application.DoEvents();
                object value = CommunicationConfigParamManger.Instance.ReadValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerFromPlc);//CommunicationConfigParamManger.Instance.GetCommunicationParam(
            ...
            switch (this._laserParam.CaliParam.CalibMethod)
            {
                case enCalibMethod.先旋转后平移:
                    // 先执行旋转
                    this.CurCaliStateEnum = enCaliStateEnum.RotCali;
                    this.CalibRotaPixList?.Clear();
                    this._laserParam.CaliParam.CalibCenterXy = new userWcsPoint(0, 0, 0); // 在开始标定前，必需将旋转中心的置0
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.RotCali, 1);
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.Cali9Pt, 0);
                    ...
                    foreach (var item in this.calibCoordConfigParamRota.CalibCoordParamList)
                    {
                        ...
                        if (this.isStop) return; // 控制标定停止
                        // 等待轴运动到位
                        switch (this._laserParam.CaliParam.CoordValueType)
                        {
                            case enCoordValueType.绝对坐标:
                                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).MoveMultyAxis(this._laserParam.CaliParam.CoordSysName,
                        ...
                        // 往地址中写入值后触发PLC  执行动作
                        CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.ResultToPlc, 3);
                        CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.FunctionNoToPlc, 5);
                        CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerToPlc, 1);
                        // 等待PLC触发采图
                        while (true)
                        {
                            if (this.isStop) return; // 控制标定停止
                            ...
                            if (value != null && value.ToString() == "1")
                            {
                                ...
                                if (Math.Abs(item.X - X) > 0.05 || Math.Abs(item.Y - Y) > 0.05 || Math.Abs(item.Theta - Theta) > 0.1)
                                {
                                    ...
                                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.ResultToPlc, 2);
                                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.FunctionNoToPlc, 5);
                                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerToPlc, 1);
                                    this.toolStripButton_Run.Enabled = true;
                                    this.toolStripButton_Stop.Enabled = false;
                        ...
                        node = this.GetExecuteNode(this._laserParam.CaliParam.CoordSysName, out info);
                    ...
                    switch (this._laserParam.CaliParam.CalculateMethod)
                    {
                        default:
                        case enCalculateMethod.拟合圆:
                            ...
                            rotaeAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                            break;
                        case enCalculateMethod.两点夹角:
                            CalibrateMethod.Instance.CalculateCenter(rowsList.ToArray(), colsList.ToArray(), this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep, out center_Row, out center_Col, out error);
                            rotaeAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                            break;
                        case enCalculateMethod.矩阵变换:
                            CalibrateMethod.Instance.CalculateCenterHomMatPix(rowsList.ToArray(), colsList.ToArray(), (this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep) * Math.PI / 180, out center_Row, out center_Col, out error);
                            rotaeAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                            break;
                    ...
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.RotCali, 0);
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.Cali9Pt, 1);
                    ...
                    this.toolStripButton_Stop.Enabled = false;
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.FunctionNoToPlc, 5);
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.ResultToPlc, 1);
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerToPlc, 1);
                    HTuple rows, cols;
                    HTuple x, y;
                    ...
                    switch (this._laserParam.CaliParam.CalibAxis)
                    {
                        default:
                        case enCalibAxis.XY轴:
                            if (this._laserParam.CaliParam.InvertX)
                                x *= -1;
                            if (this._laserParam.CaliParam.InvertY)
                                y *= -1;
                            //this._laserParam.HomMat3D = CalibrateMethod.Instance.NpointCalib(rows, cols, x, y, out error); // 更新了矩阵
                            break;
                        case enCalibAxis.单轴:
                        case enCalibAxis.X轴:
                        case enCalibAxis.Y轴:
                            //this._laserParam.HomMat3D = CalibrateMethod.Instance.NpointCalibSingleAxis(rows, cols, x, y, this._laserParam.CaliParam.InvertX, this._laserParam.CaliParam.InvertY, out error); // 更新了矩阵
                            break;
                    }
                    this._laserParam.CaliParam.CalibCenterXy = new userWcsPoint(0, 0, 0); // 这里要置0
                    MessageBox.Show("N点标定最大误差:" + error.ToString("f3") + ";标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
                case enCalibMethod.先平移后旋转:
                    ...
                    switch (this._laserParam.CaliParam.CalibAxis)
                    {
                        ...
                        case enCalibAxis.XY轴:
                            ...
                            if (this._laserParam.CaliParam.InvertY)
                                y *= -1;
                            //this._laserParam.HomMat2D = CalibrateMethod.Instance.NpointCalib(rows, cols, x, y, out error); // 更新了矩阵
                            break;
                        case enCalibAxis.单轴:
                        case enCalibAxis.X轴:
                        case enCalibAxis.Y轴:
                            //this._laserParam.HomMat2D = CalibrateMethod.Instance.NpointCalibSingleAxis(rows, cols, x, y, this._laserParam.CaliParam.InvertX, this._laserParam.CaliParam.InvertY, out error); // 更新了矩阵
                            break;
                    }
                    MessageBox.Show("N点标定最大误差:" + error.ToString("f4") + ";标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    ...
                    foreach (var item in this.calibCoordConfigParamRota.CalibCoordParamList)
                    {
                        ...
                        while (true)
                        {
                            if (this.isStop) return; // 控制标定停止
                            Application.DoEvents();
                            object value = CommunicationConfigParamManger.Instance.ReadValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerFromPlc);
                            if (value != null && value.ToString() == "1")
                            {
                                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.X轴, out X);
                                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.Y轴, out Y);
                    ...
                    {
                        switch (this._laserParam.CaliParam.CoordOriginType)
                        {
                    ...
                    switch (this._laserParam.CaliParam.CalculateMethod)
                    {
                        ...
                        case enCalculateMethod.拟合圆:
                            ...
                            break;
                        case enCalculateMethod.两点夹角:
                            CalibrateMethod.Instance.CalculateCenter(list_x.ToArray(), list_y.ToArray(), this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep, out Center_x, out Center_y, out error);
                            rotaeAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                            break;
                        case enCalculateMethod.矩阵变换:
                            CalibrateMethod.Instance.CalculateCenterHomMatWcs(list_x.ToArray(), list_y.ToArray(), this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep, out Center_x, out Center_y, out error);
                            rotaeAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                            break;
                        case enCalculateMethod.N点矩阵变换:
                    ...
                    this._laserParam.CaliParam.CalibCenterXy = new userWcsPoint(Center_x, Center_y, 0);
                    // 标定完成
                    MessageBox.Show("标定完成,最大旋转标定误差：" + error.ToString("f3") + ";圆心X = " + Center_x.ToString("f3") + ";圆心Y = " + Center_y.ToString("f3") + ";步长角 = " + rotaeAngle.ToString("f4") + ";标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
                case enCalibMethod.仅N点平移:
                    ...
                    MessageBox.Show("标定误差" + error.ToString() + "标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
                case enCalibMethod.标定板N点标定:
                    ...
                    //this._laserParam.HomMat3D = CalibrateMethod.Instance.NpointCalib(rows, cols, x, y, out error); // 更新了矩阵
                    this.MoveOriginToImageCenter();
                    MessageBox.Show("最大标定误差" + error.ToString("f3") + "标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
            }
            ...
            this._laserParam.ImagePointsToWorldPlane(row, col, 0, 0, 0, out wcs_x, out wcs_y, out wcs_z);
            ...
            ///////////////////////
            this.drawObject.AddViewObject(new ViewData(new userWcsCoordSystem(this._laserParam)));
        }
        ...
        private void CalibSocketNew()
        {
            ...
            switch (this._laserParam.CaliParam.CalibMethod)
            {
                case enCalibMethod.先旋转后平移:
                    ...
                    foreach (var item in this.calibCoordConfigParamRota.CalibCoordParamList)
                    {
                        ...
                        Thread.Sleep(100);
                        LoggerHelper.Info("等待轴运动到指定位置:" + "X = " + item.X.ToString("f3") + "  Y = " + item.Y.ToString("f3") + "  Theta = " + item.Theta.ToString("f3"));
                        CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.ResultToPlc, "Continue");
                        CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerToPlc, 1); // 表示完成
                        // 等待PLC触发采图
                        while (true)
                        {
                            if (this.isStop) return; // 控制标定停止
                            ...
                            if (value != null && value.ToString() == "1")
                            {
                                ...
                                if (Math.Abs(item.X - X) > 0.05 || Math.Abs(item.Y - Y) > 0.05 || Math.Abs(item.Theta - Theta) > 0.1)
                                {
                                    ...
                                    this.toolStripButton_Stop.Enabled = false;
                                    MessageBox.Show("PLC 没有运动到指定位置，请确认是否到限位或轴是否有移动!");
                                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.ResultToPlc, "NG");
                                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerToPlc, 1);
                                    return;
                                }
                                else
                    ...
                    switch (this._laserParam.CaliParam.CalculateMethod)
                    {
                        ...
                        case enCalculateMethod.拟合圆:
                            CalibrateMethod.Instance.CalculateFitCenter(rowsList.ToArray(), colsList.ToArray(), out center_Row, out center_Col);
                            rotateAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                            break;
                        case enCalculateMethod.两点夹角:
                            CalibrateMethod.Instance.CalculateCenter(rowsList.ToArray(), colsList.ToArray(), this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep, out center_Row, out center_Col, out error);
                            rotateAngle = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
                    ...
                    this.toolStripButton_Run.Enabled = true;
                    this.toolStripButton_Stop.Enabled = false;
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.ResultToPlc, "OK");
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.TriggerToPlc, 1); // 表示完成
                    HTuple rows, cols;
                    HTuple x, y;
                    CalibrateMethod.Instance.PixPointToHtuple(this.CalibNPointPixList, out rows, out cols);
                    ...
                    switch (this._laserParam.CaliParam.CalibAxis)
                    {
                        ...
                        case enCalibAxis.XY轴:
                            ...
                            if (this._laserParam.CaliParam.InvertY)
                                y *= -1;
                            //this._laserParam.HomMat2D = CalibrateMethod.Instance.NpointCalib(rows.DArr, cols.DArr, x.DArr, y.DArr, out error); // 更新了矩阵
                            break;
                        case enCalibAxis.单轴:
                        case enCalibAxis.X轴:
                        case enCalibAxis.Y轴:
                    ...
                    this._laserParam.CaliParam.CalibCenterXy = new userWcsPoint(0, 0, 0); // 这里要置0
                    MessageBox.Show("标定最大误差:" + error.ToString() + " 标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
                case enCalibMethod.先平移后旋转:
                    // 先执行平移
                    this.CurCaliStateEnum = enCaliStateEnum.Cali9Pt;
                    this.CalibNPointPixList?.Clear();
                    this._laserParam.CaliParam.CalibCenterXy = new userWcsPoint(0, 0, 0);  // 这里需要先清零
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.RotCali, 0);
                    CommunicationConfigParamManger.Instance.WriteValue(this._laserParam.CaliParam.CoordSysName, enCommunicationCommand.Cali9Pt, 1);
                    if (this.calibCoordConfigParamNPoint.CalibCoordParamList.Count == 0)
                    {
                    ...
                    MessageBox.Show("N点标定误差：" + error.ToString() + ";标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    //this.MoveOriginToImageCenter();
                    // 再执行旋转
                    this.CurCaliStateEnum = enCaliStateEnum.RotCali;
                    //this.CalibRotaPixList?.Clear();
                    ...
                    this._laserParam.CaliParam.CalibCenterXy = new userWcsPoint(Center_x, Center_y, 0);
                    MessageBox.Show("最大旋转标定误差：" + error.ToString("f3") + "圆心X = " + Center_x.ToString("f3") + "圆心Y = " + Center_y.ToString("f3") + "步长角 = " + rotateAngle.ToString("f3") + "标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
                case enCalibMethod.仅N点平移:
                    this.CurCaliStateEnum = enCaliStateEnum.Cali9Pt;
                    this.CalibNPointPixList?.Clear();
                ...
                case enCalibMethod.标定板N点标定:
                    ...
                    //this._laserParam.HomMat2D = CalibrateMethod.Instance.NpointCalib(rows.DArr, cols.DArr, x.DArr, y.DArr, out error); // 更新了矩阵
                    this.MoveOriginToImageCenter();
                    MessageBox.Show("最大标定误差" + error.ToString() + ";标定矩阵:" + this._laserParam.HomMat3D.ToString());
                    break;
            }
            //// 计算图像4个角点的坐标，验证标定矩阵的方向是否正确
            int width = 0, height = 0;
            ...
            //GetWcsPoint(this.CalibNPointPixList, this._laserParam, out wcs_x, out wcs_y);
        ...
        private void CalibSocketNewXZ()
        {
            ...
            this.CalibRotaPixList?.Clear();
            this.CalibRotaWcsList?.Clear();
            this._laserParam.CaliParam.CalibCenterXz = new userWcsPoint(0, 0, 0);
            //////////////////////////////////////////////////////////////
            ...
            foreach (var item in this.calibCoordConfigParamRotaV.CalibCoordParamList)
            {
                ...
                string info;
                TreeNode node = this.GetExecuteNode(this._laserParam.CaliParam.CoordSysName, out info);
                LoggerHelper.Info("接收PLC触发信号!!!" + info);
                if (node != null)
                    ((IFunction)node.Tag)?.Execute(node);
                else
            ...
            this._laserParam.CaliParam.CalibCenterXz = new userWcsPoint(Center_x, this._laserParam.CaliParam.CalibCenterXy.Y, Center_z);
        ...
        private void CalibSocketNewYZ()
        {
            ...
            this._laserParam.CaliParam.CalibCenterXz = new userWcsPoint(this._laserParam.CaliParam.CalibCenterXy.X, Center_y, Center_z);
            ...
            switch (e.ClickedItem.Text)
            {
                ...
                case "执行":
                    switch (this.运控平台comboBox.Text)
                    {
                        case "PLC":
                            ...
                            switch (this._laserParam.CaliParam.CalibPlane)
                            {
                                default:
                ...
                case "保存":
                    if (this.programPath == null || this.programPath.Length == 0)
                    {
                        ...
                        if (this._treeViewWrapClassNPoint.SaveProgram(this.programPath + "\\" + this._laserParam.SensorName))
                    ...
                    {
                        if (this._treeViewWrapClassNPoint.SaveProgram(this.programPath + "\\" + this._laserParam.SensorName)) //+ "\\" + this.CamParam.SensorName
                            MessageBox.Show("保存成功");
                        else
                            MessageBox.Show("保存失败" + new Exception().ToString());
                    }
        ...
        private void Cam9PointCalibrateForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                BaseFunction.ExcuteCompleted -= new ExcuteCompletedEventHandler(DisplayExcuteResult);
                TreeViewWrapClass.ClickNode -= new ClickNodeEventHandler(this.DisplayClickObject);
                this.calibCoordConfigParamRota.Save(programPath + "\\" + this._laserParam.SensorName + "\\" + "RotaCalibConfigParam.xml");
                this.calibCoordConfigParamRotaU.Save(programPath + "\\" + this._laserParam.SensorName + "\\" + "RotaCalibConfigParamUAxis.xml");
                this.calibCoordConfigParamRotaV.Save(programPath + "\\" + this._laserParam.SensorName + "\\" + "RotaCalibConfigParamVAxis.xml");
                this.calibCoordConfigParamNPoint.Save(programPath + "\\" + this._laserParam.SensorName + "\\" + "NPointCalibConfigParam.xml");
        ...
        private void 生成旋转坐标button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Math.DivRem((int)this._laserParam.CaliParam.AngleStep, 2, out result);
                if (result == 1) this._laserParam.CaliParam.AngleStep += 1;   // 让旋转步数为奇数
                this.旋转步数numericUpDown.Value = (decimal)this._laserParam.CaliParam.AngleStep;
                switch (this.旋转方向comboBox.Text)
                {
                    default:
                    case "双向":
                        for (int i = (int)((this._laserParam.CaliParam.AngleStep) * -0.5); i <= (int)((this._laserParam.CaliParam.AngleStep) * 0.5); i++)
                        {
                            this.calibCoordConfigParamRota.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
                                this._laserParam.CaliParam.RotateCalibPoint.Z,
                                this._laserParam.CaliParam.RotateCalibPoint.Angle + i * this._laserParam.CaliParam.AngleRange * 1.0 / this._laserParam.CaliParam.AngleStep
                        ...
                        break;
                    case "正向":
                        for (int i = 0; i <= (int)((this._laserParam.CaliParam.AngleStep)); i++)
                        {
                            this.calibCoordConfigParamRota.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
                        ...
                        break;
                    case "负向":
                        for (int i = 0; i >= (int)((this._laserParam.CaliParam.AngleStep) * -1); i--)
                        {
                            this.calibCoordConfigParamRota.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
                ...
                double value = this._laserParam.CaliParam.AngleRange / this._laserParam.CaliParam.AngleStep;
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
        ...
        private void 生成N点坐标button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double step_x = (this._laserParam.CaliParam.EndCalibPoint.X - this._laserParam.CaliParam.StartCaliPoint.X) / (colCount - 1);
                double step_y = (this._laserParam.CaliParam.EndCalibPoint.Y - this._laserParam.CaliParam.StartCaliPoint.Y) / (rowCount - 1);
                for (int i = 0; i < rowCount; i++)
                {
                    for (int j = 0; j < colCount; j++)
                    {
                        this.calibCoordConfigParamNPoint.CalibCoordParamList.Add(new CoordSysAxisParam(
                            this._laserParam.CaliParam.StartCaliPoint.X + j * step_x,
                            this._laserParam.CaliParam.StartCaliPoint.Y + i * step_y,
                            this._laserParam.CaliParam.StartCaliPoint.Z,
                            this._laserParam.CaliParam.StartCaliPoint.Angle));
                    }
                }
                for (int i = 0; i < this.N点坐标dataGridView.Rows.Count; i++)
                {
        ...
        private void 角度范围numericUpDown_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (this.isLoad)
                    this._laserParam.CaliParam.AngleRange = (double)this.角度范围numericUpDown.Value;
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
        ...
        private void 旋转步数numericUpDown_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (this.isLoad)
                    this._laserParam.CaliParam.AngleStep = (double)this.旋转步数numericUpDown.Value;
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
        ...
        private void 起始点textBox_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (content.Length > 0)
                        this._laserParam.CaliParam.StartCaliPoint.X = Convert.ToDouble(content[0]);
                    if (content.Length > 1)
                        this._laserParam.CaliParam.StartCaliPoint.Y = Convert.ToDouble(content[1]);
                    if (content.Length > 2)
                        this._laserParam.CaliParam.StartCaliPoint.Angle = Convert.ToDouble(content[2]);
                }
            }
            catch (Exception ex)
            {
        ...
        private void 终止点textBox_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (content.Length > 0)
                        this._laserParam.CaliParam.EndCalibPoint.X = Convert.ToDouble(content[0]);
                    if (content.Length > 1)
                        this._laserParam.CaliParam.EndCalibPoint.Y = Convert.ToDouble(content[1]);
                    if (content.Length > 2)
                        this._laserParam.CaliParam.EndCalibPoint.Angle = Convert.ToDouble(content[2]);
                }
            }
            catch (Exception ex)
            {
        ...
        private void 相机轴坐标textBox_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (content.Length > 0)
                        this._laserParam.CaliParam.CamAxisCoord.X = Convert.ToDouble(content[0]);
                    if (content.Length > 1)
                        this._laserParam.CaliParam.CamAxisCoord.Y = Convert.ToDouble(content[1]);
                }
            }
            catch (Exception ex)
            {
        ...
        private void 归一化原点checkBox_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (this._laserParam.CaliParam.CalibMethod == enCalibMethod.先旋转后平移) return; // 如果是先旋转后平移模式，那么将不能归一化原点
                if (this._laserParam.CaliParam.CoordOriginType == enCoordOriginType.IsLoading) return; // 上料模式
                ...
                this.drawObject.BackImage.Image.GetImageSize(out width, out height);
                double wcs_x, wcs_y, wcs_z;
                this._laserParam.ImagePointsToWorldPlane(height * 0.5, width * 0.5, 0, 0, 0, out wcs_x, out wcs_y, out wcs_z);
                if (Math.Abs(wcs_x) > 0.0005)
                    this._laserParam.HomMat3D.c02 -= wcs_x;
                if (Math.Abs(wcs_y) > 0.0005)
                    this._laserParam.HomMat3D.c12 -= wcs_y;
                //////// 平移原点后需要改变拍照点的XY坐标，这样就相当于，原点在图像中心位置来进行标定
                this._laserParam.CaliParam.StartCaliPoint.X += wcs_x;
                this._laserParam.CaliParam.StartCaliPoint.Y += wcs_y;
                this._laserParam.CaliParam.EndCalibPoint.X += wcs_x;
                this._laserParam.CaliParam.EndCalibPoint.Y += wcs_y;
            ...
            try
            {
                switch (this.上相机实时采集checkBox.CheckState)
                {
                    case CheckState.Checked:
                        ...
                        AcqSource acqSource = AcqSourceManage.Instance.GetCamAcqSource(this._laserParam.SensorName);
        ...
        private void 生成U轴旋转坐标button_Click(object sender, EventArgs e)
        {
            try
            {
                int result = -1;
                this.calibCoordConfigParamRotaU.CalibCoordParamList.Clear();
                Math.DivRem((int)this._laserParam.CaliParam.AngleStepAxisU, 2, out result);
                if (result == 1) this._laserParam.CaliParam.AngleStepAxisU += 1;   // 让旋转步数为奇数
                this.U轴旋转步数numericUpDown.Value = (decimal)this._laserParam.CaliParam.AngleStepAxisU;
                switch (this.U轴旋转方向comboBox.Text)
                {
                    default:
                    case "双向":
                        for (int i = (int)((this._laserParam.CaliParam.AngleStepAxisU) * -0.5); i <= (int)((this._laserParam.CaliParam.AngleStepAxisU) * 0.5); i++)
                        {
                            this.calibCoordConfigParamRotaU.CalibCoordParamList.Add(new CoordSysAxisParam(
                                ...
                                this._laserParam.CaliParam.RotateCalibPoint.Z,
                                0,
                                this._laserParam.CaliParam.RotateCalibPoint.Angle + i * this._laserParam.CaliParam.AngleRangeAxisU * 1.0 / this._laserParam.CaliParam.AngleStepAxisU,
                                0
                                //this.CamParam.CaliParam.RotCenter.Angle - this.CamParam.CaliParam.AngleRange + i * this.CamParam.CaliParam.AngleRange * 2 / this.CamParam.CaliParam.AngleStep
                                ));
                        }
                        break;
                    case "正向":
                        for (int i = 0; i <= (int)((this._laserParam.CaliParam.AngleStepAxisU)); i++)
                        {
                            this.calibCoordConfigParamRotaU.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
                        ...
                        break;
                    case "负向":
                        for (int i = 0; i >= (int)((this._laserParam.CaliParam.AngleStepAxisU) * -1); i--)
                        {
                            this.calibCoordConfigParamRotaU.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
        ...
        private void 获取相机轴坐标but_Click(object sender, EventArgs e)
        {
            try
            {
                double X = 0, Y = 0, Z = 0, Theta = 0, U = 0, V = 0;
                //Read(out X, out Y, out Z, out Theta, out U, out V);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.X2轴, out X);
                MotionCardManage.GetCard(this._laserParam.CaliParam.CoordSysName).GetAxisPosition(this._laserParam.CaliParam.CoordSysName, enAxisName.Y2轴, out Y);
                ///////////////////////
                this._laserParam.CaliParam.CamAxisCoord = new userWcsPoint(X, Y, Z);
        ...
        private void 生成V轴旋转坐标button_Click(object sender, EventArgs e)
        {
            try
            {
                int result = -1;
                this.calibCoordConfigParamRotaV.CalibCoordParamList.Clear();
                Math.DivRem((int)this._laserParam.CaliParam.AngleStepAxisV, 2, out result);
                if (result == 1) this._laserParam.CaliParam.AngleStepAxisV += 1;   // 让旋转步数为奇数
                this.V轴旋转步数numericUpDown.Value = (decimal)this._laserParam.CaliParam.AngleStepAxisV;
                switch (this.V轴旋转方向comboBox.Text)
                {
                    default:
                    case "双向":
                        for (int i = (int)((this._laserParam.CaliParam.AngleStepAxisV) * -0.5); i <= (int)((this._laserParam.CaliParam.AngleStepAxisV) * 0.5); i++)
                        {
                            this.calibCoordConfigParamRotaV.CalibCoordParamList.Add(new CoordSysAxisParam(
                                ...
                                0,
                                0,
                                this._laserParam.CaliParam.RotateCalibPoint.Angle + i * this._laserParam.CaliParam.AngleRangeAxisV * 1.0 / this._laserParam.CaliParam.AngleStepAxisV
                                //this.CamParam.CaliParam.RotCenter.Angle - this.CamParam.CaliParam.AngleRange + i * this.CamParam.CaliParam.AngleRange * 2 / this.CamParam.CaliParam.AngleStep
                                ));
                        }
                        break;
                    case "正向":
                        for (int i = 0; i <= (int)((this._laserParam.CaliParam.AngleStepAxisV)); i++)
                        {
                            this.calibCoordConfigParamRotaV.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
                        ...
                        break;
                    case "负向":
                        for (int i = 0; i >= (int)((this._laserParam.CaliParam.AngleStepAxisV) * -1); i--)
                        {
                            this.calibCoordConfigParamRotaV.CalibCoordParamList.Add(new CoordSysAxisParam(
                                this._laserParam.CaliParam.RotateCalibPoint.X,
                                this._laserParam.CaliParam.RotateCalibPoint.Y,
