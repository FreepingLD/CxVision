...
namespace FunctionBlock
{
    ...
    public partial class MachineCalibForm : Form
    {
        ...
        private BindingList<CoordSysAxisPosParam> listWcsPoint;
        ...
        private void 标定button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                new UserMessageForm().ShowDialog("标定成功:" + this.CamParam.HomMat2D.ToString() + "最大误 = " + error.ToString());
                /// 写到表格中
                ...
                foreach (var item in listWcsPoint)
                {
                    ...
                    if (this.CamParam.CaliParam.CoordValueType == enCoordValueType.绝对坐标)
                        MotionCardManage.GetCard(this.CamParam.CaliParam.CoordSysName).MoveMultyAxis(this.CamParam.CaliParam.CoordSysName,
                            enAxisName.XY轴, 10, new CoordSysAxisPosParam(item.X, item.Y, item.Z, item.Theta, 0, 0));
                    else
                        MotionCardManage.GetCard(this.CamParam.CaliParam.CoordSysName).MoveMultyAxis(this.CamParam.CaliParam.CoordSysName,
                                                 enAxisName.XY轴, 10, new CoordSysAxisPosParam(item.X - X, item.Y - Y, 0, item.Theta - Theta, 0, 0));
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
