...
{
    public partial class TiltPolynomialForm : Form
    {
        private HTuple camParam;
        public TiltPolynomialForm()
        {
            InitializeComponent();
        }
        public TiltPolynomialForm(HTuple camPara)
        {
            InitializeComponent();
            ...
            this.倾斜textBox.Text = camPara[6].O.ToString();
            this.旋转textBox.Text = camPara[7].O.ToString();
            this.像元宽textBox.Text = camPara[8].O.ToString();
            this.像元高textBox.Text = camPara[9].O.ToString();
            this.中心点x坐标textBox.Text = camPara[10].O.ToString();
            this.中心点y坐标textBox.Text = camPara[11].O.ToString();
            this.图像宽textBox.Text = camPara[12].O.ToString();
            this.图像高textBox.Text = camPara[13].O.ToString();
        }
