...
{
    public partial class TransformObject3DToImageForm : Form
    {
        ...
        public TransformObject3DToImageForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(TransformObject3DToXYZImage.enShowItems));
                this.图像宽度textBox.DataBindings.Add("Text", (TransformObject3DToXYZImage)this._function, "ImageWidth", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
