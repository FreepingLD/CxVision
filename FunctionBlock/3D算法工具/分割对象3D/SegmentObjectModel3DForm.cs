...
{
    public partial class SegmentObjectModel3DForm : Form
    {
        private Form form;
        private IFunction _function;
        private VisualizeView  drawObject;

        public SegmentObjectModel3DForm(IFunction function,TreeNode node)
        {
            ...
            //new DataGridViewWrapClass().InitDataGridView(this, node, this.dataGridView1, ((Rectangle2Crop)this._function).Coord1Table);
        }
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.dataGridView1.DataSource = ((Rectangle2Crop)this._function).ListRect2;
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(Path))
                {
                    ...
                    while (true)
                    {
                        ...
                        ((SegmentObjectModle3D)_function).Coord1Table.Rows.Add(new object[] { X, Y, Z, deg, legnth1, legnth2 }); // 每更改一次数据源会触发一次dataGridView的数据绑定完成事件
                    }
                }
            }
            catch (Exception ex)
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                ...
                this.drawObject.AttachPropertyData.Clear();
                userWcsCoordSystem userWcsCoordSystem = ((SegmentObjectModle3D)_function).extractRefSource2Data();
