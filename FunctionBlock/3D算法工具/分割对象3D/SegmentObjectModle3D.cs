...
namespace FunctionBlock
{
    ...
    /// </summary>
    [Serializable]
    public class SegmentObjectModle3D : BaseFunction, IFunction
    {
        [NonSerialized]
        ...
        public bool SegmentObjectModel3DByPlane(HObjectModel3D targetObjectModel, userWcsRectangle2[] rect2, string polarity, double planeOffset, out HObjectModel3D segmentObjectModel3D)
        {
            ...
            try
            {
                ...
                /////////////////////////////////////////////////////
                //new Rectangle2Crop().ReduceObjectModel3dByRectangle2(targetObjectModel, rect2, this.insideOrOutside, out reduceObjectModel); //  获取分割平面 
                /////////////
        ...
        private userWcsRectangle2[] TransformPointParamsToRect2(userWcsCoordSystem ref_Pose)
        {
            ...
            for (int i = 0; i < legnth; i++)
            {
                ...
                Convert.ToDouble(dataRow[i]["角度"]), Convert.ToDouble(dataRow[i]["半长lenght1"]), Convert.ToDouble(dataRow[i]["半宽length2"])), ref_Pose.GetVariationPose3D(), out rect2[i]);
            }
            return rect2;
        }
