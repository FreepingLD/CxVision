...
{
    public partial class FaceToFaceAngleForm : Form
    {
        private Form form;
        ...
        public FaceToFaceAngleForm(IFunction function,TreeNode node)
        {
        ...
        private void FaceToFaceAngleForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.FaceToFaceAngle.enShowItems));
                //this.dataGridView1.DataSource = ((FunctionBlock.FaceToFaceAngle)this._function).ResultDataTable;
                this.标准值textBox.DataBindings.Add("Text", (FunctionBlock.FaceToFaceAngle)this._function, "StdValue", true, DataSourceUpdateMode.OnPropertyChanged);
                this.上公差textBox.DataBindings.Add("Text", (FunctionBlock.FaceToFaceAngle)this._function, "UpTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                this.下公差textBox.DataBindings.Add("Text", (FunctionBlock.FaceToFaceAngle)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void FaceToFaceAngleForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
