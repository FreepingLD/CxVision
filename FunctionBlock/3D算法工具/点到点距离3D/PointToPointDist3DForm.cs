...
{
    public partial class PointToPointDist3DForm : Form
    {
        ...
        public PointToPointDist3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.dataGridView1.DataSource = ((PointToPointDist3D)this._function).ResultDataTable;
            }
            catch (Exception ee)
            {
