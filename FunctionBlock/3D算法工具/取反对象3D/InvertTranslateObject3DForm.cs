...
{
    public partial class InvertTranslateObject3DForm : Form
    {
        private object _objectDataModel;
        private Form form;
        private IFunction _function;
        private VisualizeView drawObject;
        public InvertTranslateObject3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.InvertTranslateObjectModel3D.enShowItems));
                this.取反对象comboBox.DataBindings.Add("Text", (FunctionBlock.InvertTranslateObjectModel3D)this._function, "InvertTarget", true, DataSourceUpdateMode.OnPropertyChanged);
                this.激光量程textBox.DataBindings.Add("Text", (FunctionBlock.InvertTranslateObjectModel3D)this._function, "MeasureRange", true, DataSourceUpdateMode.OnPropertyChanged);
                this.平移距离textBox.DataBindings.Add("Text", (FunctionBlock.InvertTranslateObjectModel3D)this._function, "TranslateDist", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
