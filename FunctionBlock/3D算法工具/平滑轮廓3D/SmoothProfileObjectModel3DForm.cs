...
{
    public partial class SmoothProfileObjectModel3DForm : Form
    {
        ...
        public SmoothProfileObjectModel3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(SmoothProfileModel3D.enShowItems));
                this.平滑方法comboBox.DataBindings.Add("Text", (SmoothProfileModel3D)this._function, "Smooth_method", true, DataSourceUpdateMode.OnPropertyChanged);
                this.平滑系数textBox.DataBindings.Add("Text", (SmoothProfileModel3D)this._function, "Smooth_value", true, DataSourceUpdateMode.OnPropertyChanged);
                this.采样距离textBox.DataBindings.Add("Text", (SmoothProfileModel3D)this._function, "Sample_dist", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
