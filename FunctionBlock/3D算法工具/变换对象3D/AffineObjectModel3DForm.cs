...
{
    public partial class AffineObjectModel3DForm : Form
    {
        ...
        public AffineObjectModel3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.变换类型comboBox.DataSource = Enum.GetNames(typeof(enTransMethod));
                this.变换类型comboBox.DataBindings.Add("Text", (FunctionBlock.AffineObjectModel3D)this._function, "TranslateMethod", true, DataSourceUpdateMode.OnPropertyChanged);
                this.取反位姿comboBox.DataBindings.Add("Text", (FunctionBlock.AffineObjectModel3D)this._function, "InvertPose", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
