...
namespace FunctionBlock
{
    public partial class ThicknessForm : Form
    {
        ...
        public ThicknessForm(IFunction function,TreeNode node)
        {
        ...
        private void ThicknessForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                //this.结果dataGridView.DataSource = ((Thickness)this._function).ResultDataTable;
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(enShowItems));
                //this.计算方法comboBox.DataSource = Enum.GetNames(typeof(enThickMeasureMethod));
                ////////////////////////////// 
                //this.计算方法comboBox.DataBindings.Add("Text", (Thickness)this._function, "CalculateMethod", true, DataSourceUpdateMode.OnPropertyChanged);
                //////////////
                //this.标准值textBox.DataBindings.Add("Text", (Thickness)this._function, "StdValue", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.上公差textBox.DataBindings.Add("Text", (Thickness)this._function, "UpTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.下公差textBox.DataBindings.Add("Text", (Thickness)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                ThicknessParam param = ((Thickness)this._function).Param;
                this.显示标签checkBox.DataBindings.Add("Checked", param, nameof(param.IsDisplayLable), true, DataSourceUpdateMode.OnPropertyChanged);
                this.字体大小numericUpDown.DataBindings.Add("Value", param, nameof(param.Size), true, DataSourceUpdateMode.OnPropertyChanged);
                this.显示标签checkBox.DataBindings.Add("Checked", param, nameof(param.IsDisplayLable), true, DataSourceUpdateMode.OnPropertyChanged);
                this.字体大小numericUpDown.DataBindings.Add("Value", param, nameof(param.Size), true, DataSourceUpdateMode.OnPropertyChanged);
