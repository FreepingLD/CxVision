...
{
    public partial class PointToFaceDist3DForm : Form
    {
        ...
        public PointToFaceDist3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.dataGridView1.DataSource = ((PointToFaceDist)this._function).ResultDataTable;
                this.平均数textBox.DataBindings.Add("Text", (PointToFaceDist)this._function, "Average_count", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        {
            if (!(sender is PointToFaceDist)) return;
            try
            {
