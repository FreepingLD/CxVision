...
{
    public partial class LineCropForm : Form
    {
        private IFunction _function;
        private VisualizeView drawObject;
        private bool isFormClose=false;
        public LineCropForm(IFunction function)
        {      
            this._function = function;
            InitializeComponent();
            this.Text = ((FunctionBlock.LineCrop)this._function).Name;
        ...
        private void ShapeCropForm_Load(object sender, EventArgs e)
        {
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.截取范围textBox.DataBindings.Add("Text", (FunctionBlock.LineCrop)this._function, "Dist_offset", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void LineCropForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            // 注消事件
            try
            {
