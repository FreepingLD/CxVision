...
{
    public partial class PointToLineDist3DForm : Form
    {
        ...
        public PointToLineDist3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.dataGridView1.DataSource = ((PointToLineDist3D)this._function).ResultDataTable;
                this.平均数textBox.DataBindings.Add("Text", (PointToLineDist3D)this._function, "Average_count", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
