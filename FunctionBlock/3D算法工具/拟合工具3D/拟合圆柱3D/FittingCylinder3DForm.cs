...
{
    public partial class FittingCylinder3DForm : Form
    {
        ...
        public FittingCylinder3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void FittingCylinder3DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                //this.dataGridView1.DataSource = ((FunctionBlock.FittingCylinder3D)this._function).ResultDataTable;
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(enShowItems));
                // this.拟合基本体comboBox.DataSource = Enum.GetNames(typeof(FittingCylinder3D.enPrimitiveType));
                this.拟合算法comboBox.DataSource = Enum.GetNames(typeof(enFitAlgorithm));
                //this.拟合基本体comboBox.DataBindings.Add("Text", (FittingCylinder3D)this._function, "PrimitiveType", true, DataSourceUpdateMode.OnPropertyChanged);
                this.拟合算法comboBox.DataBindings.Add("Text", ((FittingCylinder3D)this._function).FtiParam, "FittingAlgorithm", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
