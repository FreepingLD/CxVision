...
{
    public partial class FittingSphere3DForm : Form
    {
        ...
        public FittingSphere3DForm(IFunction function, TreeNode node)
        {
        ...
        private void FittingSphere3DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.拟合算法comboBox.DataBindings.Add("Text", ((FittingSphere3D)this._function).FtiParam, "FittingAlgorithm", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
