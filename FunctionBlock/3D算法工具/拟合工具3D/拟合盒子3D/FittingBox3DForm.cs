...
{
    public partial class FittingBox3DForm : Form
    {
        ...
        public FittingBox3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void FittingBox3DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //this.dataGridView1.DataSource = ((FunctionBlock.FittingBox3D)this._function).ResultDataTable;
                this.拟合算法comboBox.DataSource = Enum.GetNames(typeof(enFitAlgorithm));
                //this.拟合基本体comboBox.DataBindings.Add("Text", (FittingSphereCylinder3D)this._function, "PrimitiveType", true, DataSourceUpdateMode.OnPropertyChanged);
                this.拟合算法comboBox.DataBindings.Add("Text", ((FunctionBlock.FittingBox3D)this._function).FtiParam, "FittingAlgorithm", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
