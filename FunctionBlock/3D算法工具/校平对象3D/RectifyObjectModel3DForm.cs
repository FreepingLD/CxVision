...
{
    public partial class RectifyObjectModel3DForm : Form
    {
        private Form form;
        ...
        public RectifyObjectModel3DForm(IFunction function, TreeNode node)
        {
        ...
        private void AppBaseForm_Load(object sender, EventArgs e)
        {
            ...
            BindProperty();
            this.drawObject.PointCloudModel3D = ((RectifyObjectModel3D)this._function).DataHandle3D;
        }
        ...
        private void BindProperty()
        {
            try
            {
                ...
                /////////////////////////////////////////////
                this.dataGridView1.DataSource = ((RectifyObjectModel3D)this._function).ParamList;
            }
            catch (Exception ee)
            {
        ...
        private void 绘制图形button_Click(object sender, EventArgs e)
        {
            try
            {
                //switch (sender)
                ...
                //                        pixRect2 = ((userWcsRectangle2)item).GetPixRectangle2();
                //                        this.drawObject.AddViewObject(new ViewData(pixRect2.GetXLD(), pixRect2.Color.ToString()));
                //                        break;
                //                    case nameof(userWcsCircle):
                //                        userPixCircle pixCircle = ((userWcsCircle)item).GetPixCircle();
                //                        this.drawObject.AddViewObject(new ViewData(pixCircle.GetXLD(), pixCircle.Color.ToString()));
                //                        break;
                //                }
                //            }
                //        }
                ...
                //        this.drawObject.DrawPixRect2OnWindow(enColor.red, out pixRect2);
                //        this.drawObject.AddViewObject(new ViewData(pixRect2.GetXLD(), pixRect2.Color.ToString()));
                //        /////////////////////////////////////////////////////////
                //        userWcsRectangle2 wcsRect2 = pixRect2.GetWcsRectangle2();
                //        //this.DataList.Add(wcsRect2);
                //        //((RectifyObjectModel3D)this._function).ParamList.Add(new drawWcsRect2(wcsRect2.x, wcsRect2.y, wcsRect2.z, wcsRect2.deg, wcsRect2.length1, wcsRect2.length2));
                //        break;
                //    default:
                //    case "圆形":
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    int index = 0;
                    PixROI pixShape;
                    BindingList<RectifyParam> listShape = ((RectifyObjectModel3D)this._function).ParamList;
        ...
        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            try
            {
                if (this.dataGridView1.Columns[e.ColumnIndex].DataPropertyName == "WcsRect2")
                {
                    /////////////////////////
