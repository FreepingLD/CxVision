...
{
    public partial class IntersectPlaneObjectModel3DForm : Form
    {
        ...
        public IntersectPlaneObjectModel3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void IntersectPlaneObjectModel3DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.IntersectPlaneObjectModel3D.enShowItems));
                this.平面范围阈值textBox.DataBindings.Add("Text", (FunctionBlock.IntersectPlaneObjectModel3D)this._function, "Dist_offset", true, DataSourceUpdateMode.OnPropertyChanged);
                this.平面Z向偏置textBox.DataBindings.Add("Text", (FunctionBlock.IntersectPlaneObjectModel3D)this._function, "PlaneZoffset", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
