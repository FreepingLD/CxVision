...
namespace FunctionBlock
{
    ...
    /// </summary>
    [Serializable]
    public class CircleCropStander : BaseFunction, IFunction
    {
        [NonSerialized]
        ...
        private userWcsCircle[] TransformPointToCircle(userWcsCoordSystem ref_Pose)
        {
            ...
            for (int i = 0; i < legnth; i++)
            {
                ...
                ref_Pose.GetCurrentPose3D(), out circle[i]);
            }
            return circle;
        }
           ...
           this.Result.Succss = false;
            try
            {
               ...
               // this.ResultDataTable.Rows.Clear();
                ...
                //OnDisplayExcuteResultEvent(this.name, HObjectModel3D.UnionObjectModel3d(this.dataHandle3D, "points_surface"));
            }
            catch (Exception ex)
            {
