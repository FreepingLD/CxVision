...
{
    public partial class RenderObjectModel3DToImageForm : Form
    {
        ...
        public RenderObjectModel3DToImageForm(IFunction function,TreeNode node)
        {      
        ...
        private void RenderObjectModel3DToImageForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(RenderObjectModel3DToImage.enShowItems));
                this.渲染类型comboBox.DataSource= Enum.GetNames(typeof(enImageRenderType));
                this.渲染类型comboBox.DataBindings.Add("Text", (RenderObjectModel3DToImage)this._function, "ImageRenderType", true, DataSourceUpdateMode.OnPropertyChanged);
                this.X分辨率textBox.DataBindings.Add("Text", (RenderObjectModel3DToImage)this._function, "Resolution_x", true, DataSourceUpdateMode.OnPropertyChanged);
                this.Y分辨率textBox.DataBindings.Add("Text", (RenderObjectModel3DToImage)this._function, "Resolution_y", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        private void RenderObjectModel3DToImageForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            // 注消事件
            try
            {
