...
{
    public partial class AngleLineLine3DForm : Form
    {
        ...
        public AngleLineLine3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void AngleLineLine3DForm_Load(object sender, EventArgs e)
        {
            // 注册事件
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.AngleLineLine3D.enShowItems));
                //this.dataGridView1.DataSource = ((FunctionBlock.AngleLineLine3D)this._function).ResultDataTable;
                this.标准值textBox.DataBindings.Add("Text", (FunctionBlock.AngleLineLine3D)this._function, "StdValue", true, DataSourceUpdateMode.OnPropertyChanged);
                this.上公差textBox.DataBindings.Add("Text", (FunctionBlock.AngleLineLine3D)this._function, "UpTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                this.下公差textBox.DataBindings.Add("Text", (FunctionBlock.AngleLineLine3D)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        {
            if (!(sender is FunctionBlock.AngleLineLine3D)) return;
            try
            {
        ...
        private void AngleLineLine3DForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (this.cts != null)
