...
{
    public partial class UnionObjectModel3DForm : Form
    {
        ...
        public UnionObjectModel3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(Union3DobjectModel.enShowItems));
