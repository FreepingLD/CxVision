...
{
    public partial class ScaleObjectModel3DForm : Form
    {
        ...
        public ScaleObjectModel3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(ScaleObjectModel3D.enShowItems));
                this.x比例textBox.DataBindings.Add("Text", (ScaleObjectModel3D)this._function, "Scale_x", true, DataSourceUpdateMode.OnPropertyChanged);
                this.y比例textBox.DataBindings.Add("Text", (ScaleObjectModel3D)this._function, "Scale_y", true, DataSourceUpdateMode.OnPropertyChanged);
                this.z比例textBox.DataBindings.Add("Text", (ScaleObjectModel3D)this._function, "Scale_z", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.频率textBox.DataBindings.Add("Text", (ScaleObjectModel3D)this._function, "Frequency", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.速度textBox.DataBindings.Add("Text", (ScaleObjectModel3D)this._function, "Speed", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.点数textBox.DataBindings.Add("Text", (ScaleObjectModel3D)this._function, "Line_Num", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
