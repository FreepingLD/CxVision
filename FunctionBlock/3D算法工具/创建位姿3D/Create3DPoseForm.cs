...
{
    public partial class Create3DPoseForm : Form
    {
        ...
        private CreatePose3DParam param;
        public Create3DPoseForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                param = ((FunctionBlock.CreatePose3D)this._function).CreateParam;
                this.x平移textBox.DataBindings.Add("Text", param, nameof(param.Tx), true, DataSourceUpdateMode.OnPropertyChanged);
                this.y平移textBox.DataBindings.Add("Text", param, nameof(param.Ty), true, DataSourceUpdateMode.OnPropertyChanged);
                this.z平移textBox.DataBindings.Add("Text", param, nameof(param.Tz), true, DataSourceUpdateMode.OnPropertyChanged);
                this.绕X旋转textBox.DataBindings.Add("Text", param, nameof(param.RotX), true, DataSourceUpdateMode.OnPropertyChanged);
                this.绕Y旋转textBox.DataBindings.Add("Text", param, nameof(param.RotY), true, DataSourceUpdateMode.OnPropertyChanged);
                this.绕Z旋转textBox.DataBindings.Add("Text", param, nameof(param.RotZ), true, DataSourceUpdateMode.OnPropertyChanged);
                this.变换顺序comboBox.DataBindings.Add("Text", param, nameof(param.OrderOfTransform), true, DataSourceUpdateMode.OnPropertyChanged);
                this.旋转顺序comboBox.DataBindings.Add("Text", param, nameof(param.OrderOfRotation), true, DataSourceUpdateMode.OnPropertyChanged);
                this.变换视图comboBox.DataBindings.Add("Text", param, nameof(param.ViewOfTransform), true, DataSourceUpdateMode.OnPropertyChanged);
                this.取反位姿comboBox.DataBindings.Add("Text", param, nameof(param.InvertPose), true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
        ...
        {
            if (!(sender is FunctionBlock.CreatePose3D)) return;
            try
            {
