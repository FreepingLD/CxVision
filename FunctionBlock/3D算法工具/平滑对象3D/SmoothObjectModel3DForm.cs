...
{
    public partial class SmoothObjectModel3DForm : Form
    {
        ...
        public SmoothObjectModel3DForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(SmoothObjectModel3D.enShowItems));
                this.propertyGrid1.SelectedObject = (SmoothObjectModel3D)this._function;
            }
            catch (Exception ee)
            {
