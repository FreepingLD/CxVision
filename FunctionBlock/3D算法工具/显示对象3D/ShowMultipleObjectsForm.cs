...
{
    public partial class ShowMultipleObjectsForm : Form
    {
        ...
        public ShowMultipleObjectsForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(ShowMultipleObjects.enShowItems));
