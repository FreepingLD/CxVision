...
{
    public partial class LineOrientationForm : Form
    {
        ...
        public LineOrientationForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                this.显示条目comboBox.DataSource = Enum.GetNames(typeof(FunctionBlock.LineOrientation3D.enShowItems));
                //this.dataGridView1.DataSource = ((FunctionBlock.LineOrientation3D)this._function).ResultDataTable;
                this.标准值textBox.DataBindings.Add("Text", (FunctionBlock.LineOrientation3D)this._function, "StdValue", true, DataSourceUpdateMode.OnPropertyChanged);
                this.上公差textBox.DataBindings.Add("Text", (FunctionBlock.LineOrientation3D)this._function, "UpTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
                this.下公差textBox.DataBindings.Add("Text", (FunctionBlock.LineOrientation3D)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
