...
namespace FunctionBlock
{
    public partial class VolumeForm : Form
    {
        ...
        public VolumeForm(IFunction function,TreeNode node)
        {      
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.dataGridView1.DataSource = ((Volume)this._function).ResultDataTable;
                this.贪婪度textBox.DataBindings.Add("Text", ((Volume)this._function), "GreedyKNN", true, DataSourceUpdateMode.OnPropertyChanged);
                this.孔填充textBox.DataBindings.Add("Text", ((Volume)this._function), "GreedyHoleFilling", true, DataSourceUpdateMode.OnPropertyChanged);
                //this.下公差textBox.DataBindings.Add("Text", (Volume)this._function, "DownTolerance", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
