...
{
    public partial class CoordAffineForm3D : Form
    {
        ...
        public CoordAffineForm3D(IFunction function)
        {
            this._function = function;
            InitializeComponent();
        }

        public CoordAffineForm3D(TreeNode node)
        {
            this._refNode = node;
        ...
        private void CoordAffineForm3D_Load(object sender, EventArgs e)
        {
            BindProperty();
