...
namespace FunctionBlock
{
    ...
    public class CoordSystemLineLine : BaseFunction, IFunction
    {
        private userWcsCoordSystem wcsCoordSystem;
        private userPixCoordSystem pixCoordSystem;
        private userPixLine _pixLine1;
        private userPixLine _pixLine2;
        ...
        public userPixLine PixLine1
        {
                            ...
                            foreach (var item in oo)
                            {
                                switch (item.GetType().Name)
                                {
                                    case nameof(userPixLine):
                                        this._pixLine1 = item as userPixLine;
                                        break;
                                    case nameof(userWcsLine):
                                        this._pixLine1 = ((userWcsLine)item).GetPixLine();
                                        break;
                                }
                            }
                        }
                        if (this._pixLine1 == null)
                            this._pixLine1 = new userPixLine();
                    }
                    else
                        this._pixLine1 = new userPixLine();
                    return _pixLine1;
            ...
            set
            {
                this._pixLine1 = value;
            }
        }

        [DisplayName("直线对象2")]
        [Description("输入属性2")]
        public userPixLine PixLine2
        {
            get
            {
                try
                    ...
                    if (this.RefSource2.Count > 0)
                    {
                        ...
                        if (oo != null && oo.Length > 0)
                            foreach (var item in oo)
                            {
                                ...
                                {
                                    case nameof(userPixLine):
                                        this._pixLine2 = item as userPixLine;
                                        break;
                                    case nameof(userWcsLine):
                                        this._pixLine2 = ((userWcsLine)item).GetPixLine();
                                        break;
                                }
                            }
                        if (this._pixLine2 == null)
                            this._pixLine2 = new userPixLine();
                    }
                    else
                        this._pixLine2 = new userPixLine();
                    return _pixLine2;
            ...
            set
            {
                this._pixLine2 = value;
            }
        }

        public CoordSysParam Param { get; set; }

        public CoordSystemLineLine()
        {
            this.Name = "坐标系_线线";
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                stopwatch.Restart();
                Result.Succss = CoordSysMethod.GenLineLineCoordPoint(this.PixLine1, this.PixLine2, this.Param, out this.pixCoordSystem);
                ...
                stopwatch.Stop();
                ///////////////////////////////////////////////////
                userPixCoordSystem userPixCoord = this.wcsCoordSystem.GetPixCoordSystem();
