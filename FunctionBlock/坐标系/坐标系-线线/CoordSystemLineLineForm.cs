...
{
    public partial class CoordSystemLineLineForm : Form
    {
        ...
        public CoordSystemLineLineForm(IFunction function,TreeNode node)
        {
        ...
        private void CoordSystemLineLineForm_Load(object sender, EventArgs e)
        {
            ...
            BindProperty();
            ///////////////////////////////
            this.drawObject.AttachPropertyData.Add(((FunctionBlock.CoordSystemLineLine)this._function).PixLine1);
            this.drawObject.AttachPropertyData.Add(((FunctionBlock.CoordSystemLineLine)this._function).PixLine2);
        }
            ...
            try
            {
                ...
                switch (this.显示条目comboBox.Text.Trim())
                {
                    case nameof(enShowItems.输入对象1):
                        object3D = ((FunctionBlock.CoordSystemLineLine)this._function).PixLine1;
                        break;
                    case nameof(enShowItems.输入对象2):
                        object3D = ((FunctionBlock.CoordSystemLineLine)this._function).PixLine2;
                        break;
        ...
        private void 角度置零but_Click(object sender, EventArgs e)
        {
            try
            {
                ((FunctionBlock.CoordSystemLineLine)this._function).Param.RefPoint_Rad = 0;
            }
            catch (Exception ex)
            {
