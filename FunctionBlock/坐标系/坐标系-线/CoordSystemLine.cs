...
namespace FunctionBlock
{
    ...
    public class CoordSystemLine : BaseFunction, IFunction
    {
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                stopwatch.Restart();
                Result.Succss = CoordSysMethod.GenLineCoordPoint(this.PixLine,this.Param,out this.pixCoordSystem);
                //////////////////////////////////
