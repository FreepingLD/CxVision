...
{
    public partial class CoordSystemCircleLineAppForm : Form
    {
        ...
        public CoordSystemCircleLineAppForm(TreeNode node, HWindowControl hWindowControl)
        {
            InitializeComponent();
        ...
        private void CoordSystemCircleLineAppForm_Load(object sender, EventArgs e)
        {
            // 注册事件
            ...
            BindProperty();
            ///////////////////////////////
            this.drawObject.AttachPropertyData.Add(((FunctionBlock.CoordSystemCircleLine)this._function).WcsCircle);
            this.drawObject.AttachPropertyData.Add(((FunctionBlock.CoordSystemCircleLine)this._function).WcsLine);
        }
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.轴方向comboBox.DataBindings.Add("Text", ((FunctionBlock.CoordSystemCircleLine)this._function).Param, "AngleAxis", true, DataSourceUpdateMode.OnPropertyChanged);
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////
                userWcsCoordSystem coordSystem = ((FunctionBlock.CoordSystemCircleLine)this._function).WcsCoordSystem;
                userPixCoordSystem coordSystemPix = ((FunctionBlock.CoordSystemCircleLine)this._function).PixCoordSystem;
                if (coordSystem != null)
                {
