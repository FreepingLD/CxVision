...
{
    public partial class CoordSystemPointLineAppForm : Form
    {
        ...
        public CoordSystemPointLineAppForm(TreeNode node, HWindowControl hWindowControl)
        {
        ...
        private void CoordSystemPointLineForm_Load(object sender, EventArgs e)
        {
            ...
            BindProperty();
            this.drawObject.AttachPropertyData.Add(((FunctionBlock.CoordSystemPointLine)this._function).WcsPoint);
            this.drawObject.AttachPropertyData.Add(((FunctionBlock.CoordSystemPointLine)this._function).WcsLine);
        }
        ...
        private void BindProperty()
        {
            try
            {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////
                userWcsCoordSystem coordSystem = ((FunctionBlock.CoordSystemPointLine)this._function).WcsCoordSystem;
                userPixCoordSystem coordSystemPix = ((FunctionBlock.CoordSystemPointLine)this._function).PixCoordSystem;
                if (coordSystem != null)
                {
        ...
        private void CoordSystemPointLineForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            // 注消事件
            try
            {
