...
{
    public partial class EllpiseGuidedForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public EllpiseGuidedForm(IFunction function)
        {
            InitializeComponent();
            ...
            //new ListBoxWrapClass().InitListBox(this.listBox2, this._function, 2);
        }  
        public EllpiseGuidedForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.引导对象comboBox.DataBindings.Add("Text", ((EllpiseAffine)this._function), "Jaw", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
