...
{
    public partial class LineGuidedForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public LineGuidedForm(IFunction function)
        {
            InitializeComponent();
        ...
        public LineGuidedForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.引导对象comboBox.DataBindings.Add("Text", ((LineAffine)this._function), "Jaw", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
