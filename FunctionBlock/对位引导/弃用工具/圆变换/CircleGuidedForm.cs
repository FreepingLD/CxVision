...
{
    public partial class CircleGuidedForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public CircleGuidedForm(IFunction function)
        {
            InitializeComponent();
        ...
        public CircleGuidedForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.引导对象comboBox.DataBindings.Add("Text", ((CircleAffine)this._function), "Jaw", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
