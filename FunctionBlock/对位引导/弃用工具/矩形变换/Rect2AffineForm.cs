...
{
    public partial class Rect2AffineForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public Rect2AffineForm(IFunction function)
        {
            InitializeComponent();
        ...
        public Rect2AffineForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.引导对象comboBox.DataBindings.Add("Text", ((Rect2Affine)this._function), "Jaw", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
