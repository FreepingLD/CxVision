...
{
    public partial class PointAffineForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public PointAffineForm(IFunction function)
        {
            InitializeComponent();
        ...
        public PointAffineForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.引导对象comboBox.DataBindings.Add("Text", ((PointAffine)this._function), "Jaw", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
