...
{
    public partial class GuidedCalibForm : Form
    {
        protected Form form;
        protected IFunction _function;
        private VisualizeView drawObject;
        public GuidedCalibForm(IFunction function)
        {
            InitializeComponent();
        ...
        public GuidedCalibForm(TreeNode node)
        {
            InitializeComponent();  
        ...
        protected void BindProperty()
        {
            try
            {
                ...
                this.引导相机comboBox.DataSource = Sensor.SensorManage.GetCamSensorName();
                ...
                this.引导相机comboBox.DataBindings.Add("Text", ((GuidedCalib)this._function).Param, "CamName", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
