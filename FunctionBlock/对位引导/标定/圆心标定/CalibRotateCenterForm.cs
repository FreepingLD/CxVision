...
{
    public partial class CalibRotateCenterForm : Form
    {
        ...
        public CalibRotateCenterForm(IFunction function)
        {
            this._function = function;
            InitializeComponent();
        }

        public CalibRotateCenterForm(TreeNode node)
        {
            this._refNode = node;
        ...
        private void CalibRotateCenterForm_Load(object sender, EventArgs e)
        {
            BindProperty();
        }
        private void BindProperty()
        {
            try
            {
                this.圆心类型comboBox.DataSource = Enum.GetNames(typeof(enMapCalibMethod));
                this.圆心类型comboBox.DataBindings.Add("Text", ((MapCalib)this._function).Param, "MapCalibMethod", true, DataSourceUpdateMode.OnPropertyChanged);
