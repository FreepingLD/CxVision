...
namespace FunctionBlock
{
    ...
    /// 激光取点采集的数据类
    /// </summary>
    public class LineInterpolationMove : BaseFunction, IFunction
    {
        // 从机台读取的坐标值
        ...
        private enAxisName moveAxis = enAxisName.XY轴直线插补;
        private ushort ioOutPort = 0;
        private bool asynchronous = false;
        private MoveCommandParam CommandParam = new MoveCommandParam(enAxisName.XY轴直线插补, 10);
        ...
        public LineInterpolationMove(IMotionControl _card)
        {
            if (_card != null)
        ...
        public LineInterpolationMove(IMotionControl _card, IFunction coordSystem)
        {
            if (_card != null)
                this._card = MotionCardManage.GetCard(_card.Name);//  new AcqSource(_camSensor);
            if (coordSystem != null)
           ...
           this.Result.Succss= false;
            ...
            try
            {
                for (int i = 0; i < dataCoord1Row.Length; i++) //
                {
                    ...
                    {
                        //case enAxisName.X轴:
                        //    CommandParam.AxisParam = new double[1] { Convert.ToDouble(dataCoord1Row[i]["X坐标"])};
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.Y轴:
                        //    CommandParam.AxisParam = new double[1] { Convert.ToDouble(dataCoord1Row[i]["Y坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.Z轴:
                        //    CommandParam.AxisParam = new double[1] { Convert.ToDouble(dataCoord1Row[i]["Z坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.U轴:
                        //    CommandParam.AxisParam = new double[1] { Convert.ToDouble(dataCoord1Row[i]["U坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.V轴:
                        //    CommandParam.AxisParam = new double[1] { Convert.ToDouble(dataCoord1Row[i]["V坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.W轴:
                        //    CommandParam.AxisParam = new double[1] { Convert.ToDouble(dataCoord1Row[i]["W坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.XY轴:
                        //    CommandParam.AxisParam = new double[2] { Convert.ToDouble(dataCoord1Row[i]["X坐标"]), Convert.ToDouble(dataCoord1Row[i]["Y坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.XYZ轴:
                        //    CommandParam.AxisParam = new double[3] { Convert.ToDouble(dataCoord1Row[i]["X坐标"]), Convert.ToDouble(dataCoord1Row[i]["Y坐标"]), Convert.ToDouble(dataCoord1Row[i]["Z坐标"]) };
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.XYZU轴:
                        //    CommandParam.AxisParam = new double[4] { Convert.ToDouble(dataCoord1Row[i]["X坐标"]), Convert.ToDouble(dataCoord1Row[i]["Y坐标"]),
                        //     Convert.ToDouble(dataCoord1Row[i]["Z坐标"]), Convert.ToDouble(dataCoord1Row[i]["U坐标"])};
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.XYZUV轴:
                        //    CommandParam.AxisParam = new double[5] { Convert.ToDouble(dataCoord1Row[i]["X坐标"]), Convert.ToDouble(dataCoord1Row[i]["Y坐标"]), Convert.ToDouble(dataCoord1Row[i]["Z坐标"]),
                        //    Convert.ToDouble(dataCoord1Row[i]["U坐标"]),Convert.ToDouble(dataCoord1Row[i]["V坐标"])};
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        //case enAxisName.XYZUVW轴:
                        //    CommandParam.AxisParam = new double[6] { Convert.ToDouble(dataCoord1Row[i]["X坐标"]), Convert.ToDouble(dataCoord1Row[i]["Y坐标"]), Convert.ToDouble(dataCoord1Row[i]["Z坐标"]),
                        //    Convert.ToDouble(dataCoord1Row[i]["U坐标"]),Convert.ToDouble(dataCoord1Row[i]["V坐标"]),Convert.ToDouble(dataCoord1Row[i]["W坐标"])};
                        //    this._card.MoveMultyAxis(CommandParam);
                        //    break;
                        default:
