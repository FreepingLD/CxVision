...
{
    public partial class FlawDetectFormNew : Form
    {
        ...
        public FlawDetectFormNew(IFunction function)
        {
        ...
        public FlawDetectFormNew(TreeNode node, ImageDataClass imageData = null, string treeViewName = null)
        {
            this._refNode = node;
        ...
        private void FlawDetectFormNew_Load(object sender, EventArgs e)
        {
            // 注册事件
