...
namespace FunctionBlock
{
    ...
    public class DetectParam
    {
        ...
        public DetectParam(string method)
        {
            this.IsDetect = true;
            this.Method = method;
            this.MinArea = 100;
    ...
    [Serializable]
    public class ThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class AutoThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class BinaryThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class CharThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class DualThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class DynThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class FastThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class HysteresisThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class LocalThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class VarThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class WatershedsThresholdParam : DetectParam
    {
    ...
    [Serializable]
    public class CallipersInspParam : DetectParam
    {
    ...
    [Serializable]
    public class ScriptInspParam : DetectParam
    {
