...
{
    public partial class SelectShapeFlawForm : Form
    {
        private SelectShapeFlawParam _param;
        public SelectShapeFlawForm(SelectFlawParam param)
        {
            this._param = param as SelectShapeFlawParam;
            InitializeComponent();
            BindProperty();
