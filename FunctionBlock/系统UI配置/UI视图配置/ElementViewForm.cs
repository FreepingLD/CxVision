...
namespace FunctionBlock
{
    public partial class ElementViewForm : Form
    {
        ...
        public ElementViewForm(bool IsVisual = true)
        {
            InitializeComponent();
            /////////////
        ...
        public ElementViewForm(BindingList<MeasureResultInfo> list)
        {
            InitializeComponent();
            /////////////
            InitDataGridView(this.dataGridView1);
        ...
        private ContentForm tabletForm = null;
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    ...
                    this.tabletForm = new ContentForm(cellValue.ToString(), this.dataGridView1[this.dataGridView1.ColumnCount-1, e.RowIndex].Value.ToString(), $"{this.dataGridView1[1, e.RowIndex].Value}");
