...
{
    public partial class DisplayPositionFormOld : Form
    {
        ...
        public DisplayPositionFormOld(ViewConfigParam viewConfigParam)
        {
            InitializeComponent();
        ...
        private void DisplayPositionForm_Load(object sender, EventArgs e)
        {
            ...
            Task.Run(() => GetCurrentPosition(this.cts.Token));
