...
namespace FunctionBlock
{
                ...
                if (this.视图名称comboBox.Text != null)
                {
                    switch (this.窗体类型comboBox.Text.Trim())
                    {
                        ...
                        case nameof(enViewForm.TryPlateParamViewForm_参数视图):
                            ...
                            break;
                        case nameof(enViewForm.LogViewForm_日志视图):
                            this.ViewName = "日志视图:" + "[" + this.视图名称comboBox.Text.ToString() + "]";
                            break;
                        case nameof(enViewForm.TouchPanelTestForm_触模板视图):
                            this.ViewName = "触模板视图:" + "[" + this.视图名称comboBox.Text.ToString() + "]";
                            break;
                        case nameof(enViewForm.InspectionModeForm_检查视图):
                            this.ViewName = "检查视图:" + "[" + this.视图名称comboBox.Text.ToString() + "]";
                            break;
                        case nameof(enViewForm.ApiForm_复判系统):
                            this.ViewName = "复判系统:" + "[" + this.视图名称comboBox.Text.ToString() + "]";
                            break;
                        case nameof(enViewForm.RDPDeskForm_远程桌面):
                            this.ViewName = "远程桌面:" + "[" + this.视图名称comboBox.Text.ToString() + "]";
                            break;  //
                        case nameof(enViewForm.CamParamForm_相机参数):
                            this.ViewName = "远程桌面:" + "[" + this.视图名称comboBox.Text.ToString() + "]";
                            break;  //
                    }
                }
    ...
    public enum enViewForm
    {
        ...
        LogViewForm_日志视图,
        TouchPanelTestForm_触模板视图,
        InspectionModeForm_检查视图,
        ApiForm_复判系统,
        RDPDeskForm_远程桌面,
        CamParamForm_相机参数,
    }
