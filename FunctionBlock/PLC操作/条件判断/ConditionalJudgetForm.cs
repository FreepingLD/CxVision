...
{
    public partial class ConditionalJudgetForm : Form
    {
        ...
        public ConditionalJudgetForm(IFunction function)
        {
            this._function = function;
            InitializeComponent();
        }

        public ConditionalJudgetForm(TreeNode node)
        {
            this._refNode = node;
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //////////////////////////////////////////////////   
                this.数据写入dataGridView.DataSource = ((ConditionalJudge)this._function).DataList;
            }
            catch (Exception ee)
            {
        ...
        private void 数据写入dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    BindingList<JudgeCommand> WriteDataList = ((BindingList<JudgeCommand>)((ConditionalJudge)this._function).DataList);
