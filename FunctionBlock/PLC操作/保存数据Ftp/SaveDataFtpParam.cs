...
namespace FunctionBlock
{
    ...
    public class SaveDataFtpParam
    {
        ...
        public string RemotePanelPath
        {
            get;
            set;
        }
        public string RemoteDmyPath
        {
            get;
            set;
        }
        ...
        public SaveDataFtpParam()
        {
            ...
            this.Code = "MOUDLEA";
            this.Step_ID = "AB400";
            this.EQP_ID = "M1A2MOLB07"; //
            this.UnitID = "M1A2MOLB07PAI100";
            this.SubUnitID = "***";
            this.DEFECTCODE = "F39";
        }
        ...
        public bool WriteData(string panel_ID, string[] imageFilePath, object[] data)
        {
            ...
            try
            {
                ...
                foreach (var item in imageFilePath)
                {
                    ...
                    {
                        first = item;
                        path = SaveImageFileToLocal(item, panel_ID);
                ...
                if (remoteImageList.Count > 0)
                    this.RemoteImagePath = remoteImageList.Last();
                ...
                this.RemotePanelPath = this.PanelPath.Replace(this.SaveFolderPath, this.FtpURI).Replace("\\", "/");
                this.RemoteDmyPath = this.DmyPath.Replace(this.SaveFolderPath, this.FtpURI).Replace("\\", "/");
                ///////////////////////////////////////////////
        ...
        public string SaveImageFileToLocal(string localFile, string Panel_ID)
        {
            string path = "", grabNo = "";
            if (File.Exists(localFile))
            {
                grabNo = new FileInfo(localFile).Name.Split('_')[0];
                path = GetLocalImageFilePath(Panel_ID, grabNo);
                if (!Directory.Exists(new FileInfo(path).DirectoryName))
                    Directory.CreateDirectory(new FileInfo(path).DirectoryName);
        ...
        public string GetLocalPanelFilePath(string Panel_ID)
        {
            ...
            filePath = string.Join("\\", "AutoMotive", "OLB", this.Step_ID, this.UnitID, date, Panel_ID, "DATA");

            return this.SaveFolderPath + "\\" + filePath + "\\" + Panel_ID + "_" + this.Step_ID + "_" + this.UnitID + "_" + "EQP" + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".csv";
        }
        public string GetRemotePanelFilePath(string Panel_ID)
        {
            ...
            filePath = string.Join("/", this.ShopCode, this.Step_ID, this.UnitID, FAB_ID + Model_ID, date, Panel_ID, "DATA");

            return this.FtpURI + "/" + filePath + "/" + Panel_ID + "_" + this.Step_ID + "_" + this.UnitID + "_" + "EQP" + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".csv";
        }
        public string GetRemoteImageFilePath(string Panel_ID)
        {
            ...
            folderPath = string.Join("/", this.ShopCode, this.ShopCode.Replace("-", ""), this.Step_ID, this.UnitID, FAB_ID + Model_ID, date, Panel_ID, "IMAGE", "EQP", "DFT");
            return this.FtpURI + "/" + folderPath + "/" + Panel_ID + "_" + this.Step_ID + "_" + this.UnitID + "_" + "EQP" + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".jpg";
        }
        public string GetLocalImageFilePath(string Panel_ID, string grabNo)
        {
            string folderPath = "";
            if (Panel_ID == null || Panel_ID.Length == 0)
                Panel_ID = "W21VP1005A0101";
            ...
            string date = DateTime.Now.ToString("yyyyMMdd");
            ///////////////////////////////////////////////////////////////////////////////////////////////////////
            folderPath = string.Join("\\", "AutoMotive", "OLB", this.Step_ID, this.UnitID, date, Panel_ID, "IMAGE"); //, "FULL"
            return this.SaveFolderPath + "\\" + folderPath + "\\" + Panel_ID + "_" + this.Step_ID + "_" + grabNo + "_" + "DFT" + "_" + "@_@_@_@_@_@" + "_" + this.DEFECTCODE + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".jpg";
        }
        public string GetLocalDmyFilePath(string Panel_ID)
        {
            ...
            return this.SaveFolderPath + "\\" + filePath + "\\" + Panel_ID + "_" + this.Step_ID + "_" + this.UnitID + "_" + "EQP" + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".csv.dmy";
        }
        ...
        public string GetRemoteDmyFilePath(string Panel_ID)
        {
            ...
            filePath = string.Join("/", this.ShopCode, this.Step_ID, this.UnitID, FAB_ID + Model_ID, date, Panel_ID, "LOG");

            return this.FtpURI + "/" + filePath + "/" + Panel_ID + "_" + this.Step_ID + "_" + this.UnitID + "_" + "EQP" + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".csv.dmy";
        }
