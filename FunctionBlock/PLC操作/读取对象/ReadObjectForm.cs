...
{
    public partial class ReadObjectForm : Form
    {
        ...
        public ReadObjectForm(IFunction function)
        {
            this._function = function;
            InitializeComponent();
        }

        public ReadObjectForm(TreeNode node)
        {
            this._refNode = node;
        ...
        private void BindProperty()
        {
            try
            {
                ...
                //////////////////////////////////////////////////
                this.数据写入dataGridView.DataSource = ((ReadData)this._function).ReadDataList;
            }
            catch (Exception ex)
            {
        ...
        private void 数据写入dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    BindingList<ReadDataCommand> readDataList = ((BindingList<ReadDataCommand>)((ReadData)this._function).ReadDataList);
