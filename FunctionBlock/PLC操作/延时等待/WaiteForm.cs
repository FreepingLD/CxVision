...
{
    public partial class WaiteForm : Form
    {
        ...
        public WaiteForm(IFunction function)
        {
            this._function = function;
            InitializeComponent();
        }

        public WaiteForm(TreeNode node)
        {
            this._refNode = node;
        ...
        private void BindProperty()
        {
            try
            {
                this.延时等待时间textBox.DataBindings.Add("Text", ((Waite)this._function), "Time", true, DataSourceUpdateMode.OnPropertyChanged);
            }
            catch (Exception ee)
            {
