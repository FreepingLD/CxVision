...
namespace FunctionBlock
{
    ...
    public class LayOffTryPlate : BaseFunction, IFunction
    {
        ...
        public OperateResult Execute(params object[] param)
        {
            ...
            try
            {
                ...
                Result.Succss = RobotLayOffMethod.CalculateTryCoord(this.TargetPoint,  this.Param, out this._platformParam);
                stopwatch.Stop();
                ////////////////////////// 补偿值 //////////////////////////////////////////////////////////////////
                ...
                OnExcuteCompleted(this.Param.CamName, this.Param.ViewWindow, this.name, this._platformParam);
            }
            catch (Exception ex)
            {
                Result.Succss = false;
