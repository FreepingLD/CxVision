...
{
    public partial class CAnisoShapeModelXLDSubForm : Form
    {
       private C_AnisoShapeModelParamXLD _shapeModel;
        public CAnisoShapeModelXLDSubForm(C_AnisoShapeModelParamXLD shapeModel)
        {
            this._shapeModel = shapeModel;
            InitializeComponent();
            BindProperty();
        }
        public CAnisoShapeModelXLDSubForm(C_ShapeModelParamBase shapeModel)
        {
