...
{
    public partial class CScaledShapeModelSubForm : Form
    {
       private C_ScaledShapeModelParam _shapeModel;
        public CScaledShapeModelSubForm(C_ScaledShapeModelParam shapeModel)
        {
            this._shapeModel = shapeModel;
            InitializeComponent();
            BindProperty();
        }
        public CScaledShapeModelSubForm(C_ShapeModelParamBase shapeModel)
        {
