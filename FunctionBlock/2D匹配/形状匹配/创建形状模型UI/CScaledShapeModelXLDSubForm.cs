...
{
    public partial class CScaledShapeModelXLDSubForm : Form
    {
       private C_ScaledShapeModelParamXLD _shapeModel;
        public CScaledShapeModelXLDSubForm(C_ScaledShapeModelParamXLD shapeModel)
        {
            this._shapeModel = shapeModel;
            InitializeComponent();
            BindProperty();
        }
        public CScaledShapeModelXLDSubForm(C_ShapeModelParamBase shapeModel)
        {
            this._shapeModel = (C_ScaledShapeModelParamXLD)shapeModel;
            InitializeComponent();
            BindProperty();
        }
