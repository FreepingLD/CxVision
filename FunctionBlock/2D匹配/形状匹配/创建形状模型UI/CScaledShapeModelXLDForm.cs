...
{
    public partial class CScaledShapeModelXLDForm : Form
    {
       private C_ScaledShapeModelParamXLD _shapeModel;
        public CScaledShapeModelXLDForm(C_ScaledShapeModelParamXLD shapeModel)
        {
            this._shapeModel = shapeModel;
            InitializeComponent();
            BindProperty();
        }
        public CScaledShapeModelXLDForm(C_ShapeModelParamBase shapeModel)
        {
