...
{
    public partial class CShapeModelXLDForm : Form
    {
       private C_ShapeModelParamXLD _shapeModel;
        public CShapeModelXLDForm(C_ShapeModelParamXLD param)
        {
            this._shapeModel = param;
            InitializeComponent();
            BindProperty();
        }
        public CShapeModelXLDForm(C_ShapeModelParamBase param)
        {
            this._shapeModel = (C_ShapeModelParamXLD)param;
            InitializeComponent();
            BindProperty();
        }
