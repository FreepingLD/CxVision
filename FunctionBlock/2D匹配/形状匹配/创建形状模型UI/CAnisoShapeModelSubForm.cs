...
{
    public partial class CAnisoShapeModelSubForm : Form
    {
        private C_AnisoShapeModelParam _shapeModel;
        public CAnisoShapeModelSubForm(C_AnisoShapeModelParam shapeModel)
        {
            this._shapeModel = shapeModel;
            InitializeComponent();
            BindProperty();
        }
        public CAnisoShapeModelSubForm(C_ShapeModelParamBase shapeModel)
        {
