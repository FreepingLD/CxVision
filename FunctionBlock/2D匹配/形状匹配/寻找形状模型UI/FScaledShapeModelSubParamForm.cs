...
{
    public partial class FScaledShapeModelSubParamForm : Form
    {
      private F_ScaledShapeModelParam _shapeModel;
        public FScaledShapeModelSubParamForm(F_ScaledShapeModelParam param)
        {
            this._shapeModel = param;
            InitializeComponent();
            BindProperty();
        }
        public FScaledShapeModelSubParamForm(F_ShapeModelParamBase param)
        {
        ...
        private void BindProperty()
        {
            try
            {
                ...
                this.过滤参数textBox.DataBindings.Add("Text", this._shapeModel, "FilterParam", true, DataSourceUpdateMode.OnPropertyChanged);
