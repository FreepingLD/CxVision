...
{
    public partial class FAnisoShapeModelSubParamForm : Form
    {
      private F_AnisoShapeModelParam _shapeModel;
        public FAnisoShapeModelSubParamForm(F_AnisoShapeModelParam param)
        {
            this._shapeModel = param;
            InitializeComponent();
            BindProperty();
        }
        public FAnisoShapeModelSubParamForm(F_ShapeModelParamBase param)
        {
