...
namespace FunctionBlock
{
    ...
    public partial class LineLaserForm : Form
    {
        ...
        public LineLaserForm(AcqSource acqSource) //AcqSource acqSource
        {
        ...
        public void UpdataView(CancellationToken token)
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    int length = _acqSource.Sensor.LaserParam.DataWidth;
                    if (length < 100)
                        continue;
                    ...
                    //////////////
                    if (!token.IsCancellationRequested && dist.Length > 0)
                    {
            ...
            {
                // new UserMessageForm().ShowDialog(e.ToString());
            }
        }
